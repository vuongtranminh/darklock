...
! function(t, e) {
    ...
    function s() {
        return Op || (Op = Lp().getContext("2d")), Op
    }
    ...
    function d(t, e, n) {
        if (t && e)
            if (t.forEach && t.forEach === Cp) t.forEach(e, n);
    ...
    function f(t, e, n) {
        if (t && e) {
            if (t.map && t.map === Ap) return t.map(e, n);
    ...
    function p(t, e, n, i) {
        if (t && e) {
            if (t.reduce && t.reduce === kp) return t.reduce(e, n, i);
    ...
    function g(t, e, n) {
        if (t && e) {
            if (t.filter && t.filter === Tp) return t.filter(e, n);
    ...
    function m(t, e) {
        var n = Dp.call(arguments, 2);
        return function() {
            return t.apply(e, n.concat(Dp.call(arguments)))
        }
    }

    function v(t) {
        var e = Dp.call(arguments, 1);
        return function() {
            return t.apply(this, e.concat(Dp.call(arguments)))
        }
    }

    function y(t) {
        return "[object Array]" === Mp.call(t)
    }
    ...
    function _(t) {
        return "[object String]" === Mp.call(t)
    }
    ...
    function A() {
        return Function.call.apply(Dp, arguments)
    }
    ...
    function St(t, e) {
        lg && bt(lg, e), lg = sg.put(t, lg || e.slice())
    }
    ...
    function Mt(t, e) {
        if (t) {
            ...
            if (i in ag) return bt(e, ag[i]), St(t, e), e;
            if ("#" !== i.charAt(0)) {
                var r = i.indexOf("("),
                    o = i.indexOf(")");
                if (-1 !== r && o + 1 === i.length) {
    ...
    function Bt(t, e, n) {
        ...
        if (i !== r)
            if (i > r) t.length = r;
                ...
                for (a = i; a < r; a++) t.push(1 === n ? e[a] : dg.call(e[a]));
    ...
    function Gt(t) {
        if (c(t)) {
            var e = t.length;
            if (c(t[0])) {
                for (var n = [], i = 0; i < e; i++) n.push(dg.call(t[i]));
                return n
            }
            return dg.call(t)
        }
            ...
            if (o || !x) {
                ...
                var O = new ft({
                    ...
                    onframe: function(t, e) {
                        ...
                        if (0 !== i)
                            if (I = (e - m[n]) / i, l)
                                if (T = v[n], C = v[0 === n ? n : n - 1], D = v[n > h - 2 ? h - 1 : n + 1], A = v[n > h - 3 ? h - 1 : n + 2], d) Ft(C, T, D, A, I, I * I, I * I * I, a(t, r), g);
                                else {
    ...
    function te(t, e, n, i) {
        ...
        if (!(r < 2)) {
            var o = 0;
            if (r < Mg) return o = Yt(t, n, i, e), void $t(t, n, i, n + o, e);
            var a = new Jt(t, e),
                s = jt(r);
            do {
                if ((o = Yt(t, n, i, e)) < s) {
    ...
    function se(t, e, n, i, r) {
        if (t) {
            if ("string" == typeof t) {
                ...
                return o ? !he(e = o.image) && o.pending.push(a) : (!e && (e = new Image), e.onload = le, Rg.put(t, e.__cachedImgObj = {
                    image: e,
                    pending: [a]
    ...
    function Me(t, e) {
        ...
        for (var i, r = Hg.lastIndex = 0; null != (i = Hg.exec(t));) {
            var o = i.index;
            o > r && Ie(n, t.substring(r, o)), Ie(n, i[2], i[1]), r = Hg.lastIndex
        }
        ...
        for (k = 0; k < a.length; k++) {
            for (var p = a[k], g = 0, m = 0, v = 0; v < p.tokens.length; v++) {
                ...
                if ("string" == typeof b && "%" === b.charAt(b.length - 1)) P.percentWidth = b, h.push(P), b = 0;
                    ...
                    null != A && A < b && (!S || A < C ? (P.text = "", P.textWidth = b = 0) : (P.text = ve(P.text, A - C, _, c.ellipsis, {
                        minChar: c.minChar
                    }), P.textWidth = ue(P.text, _), b = P.textWidth + C))
                }
    ...
    function Ae(t) {
        if (t) {
            ...
            "center" === n && (n = "middle"), t.textVerticalAlign = null == n || Ug[n] ? n : "top", t.textPadding && (t.textPadding = k(t.textPadding))
        }
    }
    ...
    function Oe(t, e, n, i, r) {
        ...
        for (var x = 0; x < n.lines.length; x++) {
            for (var _, w = n.lines[x], b = w.tokens, S = b.length, M = w.lineHeight, I = w.width, C = 0, T = m, D = y, A = S - 1; C < S && (!(_ = b[C]).textAlign || "left" === _.textAlign);) Ee(t, e, _, i, M, v, T, "left"), I -= _.width, T += _.width, C++;
            for (; A >= 0 && "right" === (_ = b[A]).textAlign;) Ee(t, e, _, i, M, v, D, "right"), I -= _.width, D -= _.width, A--;
            for (T += (o - (T - m) - (y - D) - I) / 2; C <= A;) Ee(t, e, _ = b[C], i, M, v, T + _.width / 2, "center"), T += _.width, C++;
            v += M
        }
    }
    ...
    function $e(t, e, n) {
        return Yg.copy(t.getBoundingRect()), t.transform && Yg.applyTransform(t.transform), qg.width = e, qg.height = n, !Yg.intersect(qg)
    }
    ...
    function en(t, e, n, i) {
        return n = n || {}, i || !wp.canvasSupported ? nn(t, e, n) : wp.browser.firefox && null != e.layerX && e.layerX !== e.offsetX ? (n.zrX = e.layerX, n.zrY = e.layerY) : null != e.offsetX ? (n.zrX = e.offsetX, n.zrY = e.offsetY) : nn(t, e, n), n
    }
    ...
    function rn(t, e, n) {
        ...
        var o = e.button;
        return null == e.which && void 0 !== o && Qg.test(e.type) && (e.which = 1 & o ? 1 : 2 & o ? 3 : 4 & o ? 2 : 0), e
    }
    ...
    function un(t) {
        return "mousewheel" === t && wp.browser.firefox ? "DOMMouseScroll" : t
    }
    ...
    function gn(t) {
        ...
        Wp.call(this), this.dom = t, this._touching = !1, this._touchTimer, this._gestureMgr = new em, this._handlers = {}, pn(this), wp.pointerEventsSupported ? e(am, this) : (wp.touchEventsSupported && e(rm, this), e(im, this))
    }
    ...
    function Mn(t) {
        ...
        pm(t, function(t, n) {
            ...
            var i = t.exist,
                ...
                o = t.keyInfo;
            if (gm(r)) {
                if (o.name = null != r.name ? r.name + "" : i ? i.name : vm + n, i) o.id = i.id;
    ...
    function Vn(t, e) {
        ...
        if (t.registerClass = function(t, e) {
                return e && (zn(e), (e = On(e)).sub ? e.sub !== wm && (n(e)[e.sub] = t) : i[e.main] = t), t
                ...
                var e = [],
                    n = i[t.main];
                return n && n[wm] ? d(n, function(t, n) {
                    n !== wm && e.push(t)
                }) : e.push(n), e
    ...
    function jn(t, e, n, i, r, o, a, s, l, h, u) {
        var c, d, f, p, g, m = .005,
            v = 1 / 0;
        zm[0] = l, zm[1] = h;
        for (var y = 0; y < 1; y += .05) Em[0] = Gn(t, n, r, a, y), Em[1] = Gn(e, i, o, s, y), (p = Fp(zm, Em)) < v && (c = y, v = p);
        v = 1 / 0;
        for (var x = 0; x < 32 && !(m < Pm); x++) d = c - m, f = c + m, Em[0] = Gn(t, n, r, a, d), Em[1] = Gn(e, i, o, s, d), p = Fp(Em, zm), d >= 0 && p < v ? (c = d, v = p) : (Nm[0] = Gn(t, n, r, a, f), Nm[1] = Gn(e, i, o, s, f), g = Fp(Nm, zm), f <= 1 && g < v ? (c = f, v = g) : m *= .5);
        return u && (u[0] = Gn(t, n, r, a, c), u[1] = Gn(e, i, o, s, c)), Am(v)
    }
    ...
    function Jn(t, e, n, i, r, o, a, s, l) {
        var h, u = .005,
            c = 1 / 0;
        zm[0] = a, zm[1] = s;
        for (var d = 0; d < 1; d += .05) Em[0] = Yn(t, n, r, d), Em[1] = Yn(e, i, o, d), (m = Fp(zm, Em)) < c && (h = d, c = m);
        c = 1 / 0;
        for (var f = 0; f < 32 && !(u < Pm); f++) {
            var p = h - u,
                g = h + u;
            Em[0] = Yn(t, n, r, p), Em[1] = Yn(e, i, o, p);
            var m = Fp(Em, zm);
            if (p >= 0 && m < c) h = p, c = m;
            else {
                Nm[0] = Yn(t, n, r, g), Nm[1] = Yn(e, i, o, g);
                var v = Fp(Nm, zm);
                g <= 1 && v < c ? (h = g, c = v) : u *= .5
            }
        }
        return l && (l[0] = Yn(t, n, r, h), l[1] = Yn(e, i, o, h)), Am(c)
    }
    ...
    function ti(t, e, n) {
        if (0 !== t.length) {
            var i, r = t[0],
                ...
                s = r[1],
                l = r[1];
            for (i = 1; i < t.length; i++) r = t[i], o = Rm(o, r[0]), a = Bm(a, r[0]), s = Rm(s, r[1]), l = Bm(l, r[1]);
    ...
    function ni(t, e, n, i, r, o, a, s, l, h) {
        ...
        for (l[0] = 1 / 0, l[1] = 1 / 0, h[0] = -1 / 0, h[1] = -1 / 0, u = 0; u < f; u++) {
            var p = d(t, n, r, a, Um[u]);
            l[0] = Rm(p, l[0]), h[0] = Bm(p, h[0])
        }
        for (f = c(e, i, o, s, Xm), u = 0; u < f; u++) {
            var g = d(e, i, o, s, Xm[u]);
            l[1] = Rm(g, l[1]), h[1] = Bm(g, h[1])
        }
        l[0] = Rm(t, l[0]), h[0] = Bm(t, h[0]), l[0] = Rm(a, l[0]), h[0] = Bm(a, h[0]), l[1] = Rm(e, l[1]), h[1] = Bm(e, h[1]), l[1] = Rm(s, l[1]), h[1] = Bm(s, h[1])
    }
    ...
    function ri(t, e, n, i, r, o, a, s, l) {
        var h = K,
            u = Q,
            c = Math.abs(r - o);
        if (c % Hm < 1e-4 && c > 1e-4) return s[0] = t - n, s[1] = e - i, l[0] = t + n, void(l[1] = e + i);
        if (Gm[0] = Fm(r) * n + t, Gm[1] = Vm(r) * i + e, Wm[0] = Fm(o) * n + t, Wm[1] = Vm(o) * i + e, h(s, Gm, Wm), u(l, Gm, Wm), (r %= Hm) < 0 && (r += Hm), (o %= Hm) < 0 && (o += Hm), r > o && !a ? o += Hm : r < o && a && (r += Hm), a) {
            var d = o;
            o = r, r = d
        }
        for (var f = 0; f < o; f += Math.PI / 2) f > r && (Zm[0] = Fm(f) * n + t, Zm[1] = Vm(f) * i + e, h(s, Zm, s), u(l, Zm, l))
    }
    ...
    function fi(t, e, n, i, r, o, a, s, l, h) {
        ...
        var u = Zn(e, i, o, s, h, cv);
        if (0 === u) return 0;
        for (var c, d, f = 0, p = -1, g = 0; g < u; g++) {
            var m = cv[g],
                v = 0 === m || 1 === m ? .5 : 1;
            Gn(t, n, r, a, m) < l || (p < 0 && (p = Un(e, i, o, s, dv), dv[1] < dv[0] && p > 1 && di(), c = Gn(e, i, o, s, dv[0]), p > 1 && (d = Gn(e, i, o, s, dv[1]))), 2 == p ? m < dv[0] ? f += c < e ? v : -v : m < dv[1] ? f += d < c ? v : -v : f += s < d ? v : -v : m < dv[0] ? f += c < e ? v : -v : f += s < c ? v : -v)
        }
        return f
    }
    ...
    function pi(t, e, n, i, r, o, a, s) {
        ...
        if (h >= 0 && h <= 1) {
            for (var u = 0, c = Yn(e, i, o, h), d = 0; d < l; d++) {
                f = 0 === cv[d] || 1 === cv[d] ? .5 : 1;
                (p = Yn(t, n, r, cv[d])) < a || (cv[d] < h ? u += c < e ? f : -f : u += o < c ? f : -f)
            }
            return u
        }
        var f = 0 === cv[0] || 1 === cv[0] ? .5 : 1,
            p = Yn(t, n, r, cv[0]);
        ...
        for (var u = 0, c = 0; c < 2; c++) {
            ...
            if (d + t > a) {
                var f = Math.atan2(s, d),
                    p = o ? 1 : -1;
                f < 0 && (f = hv + f), (f >= i && f <= r || f + hv >= i && f + hv <= r) && (f > Math.PI / 2 && f < 1.5 * Math.PI && (p = -p), u += p)
            }
        }
        return u
    }
    ...
    function mi(t, e, n, i, r) {
        for (var o = 0, a = 0, s = 0, l = 0, h = 0, u = 0; u < t.length;) {
            var c = t[u++];
            switch (c === lv.M && u > 1 && (n || (o += ui(a, s, l, h, i, r))), 1 == u && (l = a = t[u], h = s = t[u + 1]), c) {
                case lv.M:
                    a = l = t[u++], s = h = t[u++];
                    break;
                case lv.L:
    ...
    function _i(t, e, n, i, r, o, a, s, l, h, u) {
        var c = l * (Iv / 180),
            d = Mv(c) * (t - n) / 2 + Sv(c) * (e - i) / 2,
            f = -1 * Sv(c) * (t - n) / 2 + Mv(c) * (e - i) / 2,
            p = d * d / (a * a) + f * f / (s * s);
        p > 1 && (a *= bv(p), s *= bv(p));
        var g = (r === o ? -1 : 1) * bv((a * a * (s * s) - a * a * (f * f) - s * s * (d * d)) / (a * a * (f * f) + s * s * (d * d))) || 0,
            m = g * a * f / s,
            v = g * -s * d / a,
            y = (t + n) / 2 + Mv(c) * m - Sv(c) * v,
            x = (e + i) / 2 + Sv(c) * m + Mv(c) * v,
            _ = Dv([1, 0], [(d - m) / a, (f - v) / s]),
            w = [(d - m) / a, (f - v) / s],
            b = [(-1 * d - m) / a, (-1 * f - v) / s],
            S = Dv(w, b);
        Tv(w, b) <= -1 && (S = Iv), Tv(w, b) >= 1 && (S = 0), 0 === o && S > 0 && (S -= 2 * Iv), 1 === o && S < 0 && (S += 2 * Iv), u.addData(h, y, x, a, s, _, S, c, o)
    }
    ...
    function zi(t) {
        var e = t.shape,
            n = t.style.lineWidth;
        return qv(2 * e.x1) === qv(2 * e.x2) && (e.x1 = e.x2 = Ni(e.x1, n, !0)), qv(2 * e.y1) === qv(2 * e.y2) && (e.y1 = e.y2 = Ni(e.y1, n, !0)), t
    }
    ...
    function tr(t, e, n, i, r, o) {
        if (n = !r && n || Qv, t.textFill = er(e.getShallow("color"), i) || n.color, t.textStroke = er(e.getShallow("textBorderColor"), i) || n.textBorderColor, t.textStrokeWidth = T(e.getShallow("textBorderWidth"), n.textBorderWidth), !r) {
            if (o) {
    ...
    function hr(t, e, n) {
        return e && !c(e) && (e = Kp.getLocalTransform(e)), n && (e = ct([], e)), $([], t, e)
    }
    ...
    function Nr(t, e, n) {
        ...
        for (var s = 0; s < i; s++)
            for (var l = 0; l < r.length; l++) {
                var h = e[s][r[l]];
                t = t.replace(py(fy[l], s), n ? Er(h) : h)
            }
        return t
    }
    ...
    function to(t) {
        ...
        if (l) {
            var h = l.option;
            n = h.source, i = By(l).sourceFormat, r = !0, o = o || h.seriesLayoutBy, null == a && (a = h.sourceHeader), s = s || h.dimensions
        }
        var u = eo(n, i, o, a, s),
            c = e.encode;
        !c && l && (c = oo(t, l, n, i, o, u)), By(t).source = new $r({
            data: n,
            fromDataset: r,
            seriesLayoutBy: o,
            sourceFormat: i,
    ...
    function eo(t, e, n, i, r) {
        ...
        var o, a, s;
        if (e === Py) "auto" === i || null == i ? io(function(t) {
            null != t && "-" !== t && (_(t) ? null == a && (a = 1) : a = 0)
        }, n, t, 10) : a = i ? 1 : 0, r || 1 !== a || (r = [], io(function(t, e) {
            r[e] = null != t ? t : ""
        }, n, t)), o = r ? r.length : n === Ry ? t.length : t[0] ? t[0].length : null;
        else if (e === Ly) r || (r = ro(t), s = !0);
        else if (e === Oy) r || (r = [], s = !0, d(t, function(t, e) {
            r.push(e)
        }));
        else if (e === ky) {
            var l = wn(t[0]);
    ...
    function uo(t, e) {
        ...
        d(e, function(e, o) {
            "colorLayer" === o && r || My.hasClass(o) || ("object" == typeof e ? t[o] = t[o] ? i(t[o], e, !1) : n(e) : null == t[o] && (t[o] = e))
        })
    }

    function co(t) {
        t = t, this.option = {}, this.option[Vy] = 1, this._componentsMap = N({
            series: []
        }), this._seriesIndices, this._seriesIndicesMap, uo(t, this._theme.option), i(t, Cy, !1), this.mergeOption(t)
    }
    ...
    function _o(t, e, n) {
        ...
        return r || (r = t), r.timeline || (r.timeline = s), Wy([r].concat(o).concat(f(a, function(t) {
            return t.option
        })), function(t) {
            Wy(e, function(e) {
                e(t, n)
    ...
    function Ro(t, e) {
        ...
        var n = this._data = t.data,
            i = t.sourceFormat;
        i === Ey && (this._offset = 0, this._dimSize = e, this._data = n), o(this, nx[i === Py ? i + "_" + t.seriesLayoutBy : i])
    }
    ...
    function Uo(t, e, n) {
        if (t) {
            ...
            if (i === ky || i === Ly) {
                ...
                return i !== ky || w(r) || (r = null), r ? r[n] : void 0
            }
        }
    }
        ...
        d(e, function(e, s) {
            if (!r.visualType || r.visualType === e.visualType) {
                ...
                if (u) {
                    ...
                    h.skip = !e.performRawSeries && n.isSeriesFiltered(s.context.model), Tx(s, i), a |= s.perform(h)
                })
            }
        }), t.unfinished |= a
    }
    ...
    function ga(t, e, n, i, r) {
        function o(e) {
            ...
            i || (i = s.set(n, Xo({
                ...
                overallProgress: u,
                modifyOutputEnd: c
            }, i.agent = a, i.__block = u, Ma(t, e, i)
        }
    ...
    function Ta(t) {
        return function(e, n, i) {
            e = e && e.toLowerCase(), Wp.prototype[t].call(this, e, n, i)
        }
    }
    ...
    function Aa(t, e, i) {
        ...
        i = i || {}, "string" == typeof e && (e = r_[e]), this.id, this.group, this._dom = t;
        var o = this._zr = mn(t, {
        ...
        this._throttledZrFlush = ha(m(o.flush, o), 17), (e = n(e)) && tx(e, !0), this._theme = e, this._chartsViews = [], this._chartsMap = {}, this._componentsViews = [], this._componentsMap = {}, this._coordSysMgr = new yo;
        var a = this._api = ja(this);
        te(i_, r), te(t_, r), this._scheduler = new da(this, a, t_, i_), Wp.call(this), this._messageCenter = new Da, this._initEvents(), this.resize = m(this.resize, this), this._pendingActions = [], o.animation.on("frame", this._onframe, this), Ra(o, this), O(this)
    }
    ...
    function La(t, e, n, i, r) {
        ...
        if (i) {
            ...
            null != h && (h = N(xn(h))), a && a.eachComponent(l, function(e) {
    ...
    function za(t, e) {
        ...
        Rx(u, function(t) {
            d = r.action(t, this._model, this._api), (d = d || o({}, t)).type = s.event || d.type, p.push(d), g ? La(this, h, t, "series") : l && La(this, h, t, l.main, l.sub)
        }, this), "none" === h || g || l || (this[jx] ? (Pa(this), $x.update.call(this, t), this[jx] = !1) : $x[h].call(this, t)), d = c ? {
            type: s.event || n,
            escapeConnect: i,
            batch: p
        } : p[0], this[Xx] = !1, !e && this._messageCenter.trigger(d.type, d)
    }
    ...
    function Ba(t, e, n, i) {
        function r(t) {
            ...
            if (!r) {
                var u = Fx(t.type);
                (r = new(o ? cx.getClass(u.main, u.sub) : ra.getClass(u.sub))).init(n, h), s[e] = r, a.push(r), l.add(r.group)
            }
    ...
    function Fa(t, e, n, i) {
        Ha(t, e, n, i), Rx(t._chartsViews, function(t) {
            t.__alive = !1
    ...
    function Ga(t, e, n, i, r) {
        ...
        }), a.unfinished |= o, Za(t._zr, e), Mx(t._zr.dom, e)
    }
    ...
    function Za(t, e) {
        ...
        n.traverse(function(t) {
            t.isGroup || i++
        }), i > e.get("hoverLayerThreshold") && !wp.node && n.traverse(function(t) {
    ...
    function ts(t, e, n) {
        ...
        t.event = (t.event || i).toLowerCase(), e = t.event, Nx(Yx.test(i) && Yx.test(e)), Qx[i] || (Qx[i] = {
            action: n,
            actionInfo: t
        }), Jx[e] = i
    }
    ...
    function us(t, e, n, i, r) {
        this._old = t, this._new = e, this._oldKeyGetter = n || hs, this._newKeyGetter = i || hs, this.context = r
    }
    ...
    function vs(t, e) {
        d(__.concat(e.__wrappedMethods || []), function(n) {
            e.hasOwnProperty(n) && (t[n] = e[n])
        }), t.__wrappedMethods = e.__wrappedMethods, d(w_, function(i) {
            t[i] = n(e[i])
    ...
    function ys(t) {
        ...
        d(e, function(n, i) {
            ...
            if (r) {
                n = e[i] = new y_(r.categories.length);
    ...
    function bs(t, e) {
        var n = t._idList[e];
        return null == n && (n = xs(t, t._idDimIdx, e)), null == n && (n = m_ + e), n
    }
    ...
    function Ms(t, e) {
        var n = t.dimensions,
            i = new b_(f(n, t.getDimensionInfo, t), t.hostModel);
        vs(i, t);
    ...
    function Ts(t, e, i) {
        function r(t, e, n) {
            null != p_.get(e) ? t.otherDims[e] = n : (t.coordDim = e, t.coordDimIndex = n, u.set(e, !0))
        }
        $r.isInstance(e) || (e = $r.seriesDataToSource(e)), i = i || {}, t = (t || []).slice();
        for (var s = (i.dimsDef || []).slice(), l = N(i.encodeDef), h = N(), u = N(), c = [], f = Ds(e, t, s, i.dimCount), p = 0; p < f; p++) {
        ...
        var x = i.generateCoord,
            ...
            S = null != b;
        b = x ? b || 1 : 0;
        for (var M = x || "value", I = 0; I < f; I++) null == (v = c[I] = c[I] || {}).coordDim && (v.coordDim = As(M, u, S), v.coordDimIndex = 0, (!x || b <= 0) && (v.isExtraCoord = !0), b--), null == v.name && (v.name = As(v.coordDim, h)), null == v.type && so(e, I, v.name) && (v.type = "ordinal");
        return c
    }
    ...
    function Ls(t, e, n) {
        ...
        var p = null != s && Os(t) ? function(t, e, n, i) {
    ...
    function Vs(t, e, n, i) {
        ...
        var s = r.intervalPrecision = Fs(a);
        return Gs(r.niceTickExtent = [A_(Math.ceil(t[0] / a) * a, s), A_(Math.floor(t[1] / a) * a, s)], t), r
    }
    ...
    function Gs(t, e) {
        !isFinite(t[0]) && (t[0] = e[0]), !isFinite(t[1]) && (t[1] = e[1]), Hs(t, 0, e), Hs(t, 1, e), t[0] > t[1] && (t[0] = t[1])
    }
    ...
    function Ws(t, e, n, i) {
        ...
        if (!t) return r;
        e[0] < n[0] && r.push(e[0]);
        for (var o = n[0]; o <= n[1] && (r.push(o), (o = A_(o + t, i)) !== r[r.length - 1]);)
    ...
    function qs(t, e, n) {
        if (t && e) {
            var i = t[Us(e)];
            return null != i && null != n && (i = i[Zs(n)]), i
        }
    }
    ...
    function il(t, e) {
        if (e = e || t.get("type")) switch (e) {
            ...
            case "value":
                return new P_;
            default:
                return (Es.getClass(e) || P_).create(t)
        }
    }
    ...
    function ol(t) {
        ...
        return "string" == typeof e ? e = function(t) {
            ...
            return null != n && (r = i - n), e(al(t, i), r)
        } : function(e) {
    ...
    function ul(t, e, n, i, r, o, a) {
        ...
        var l;
        return l = 0 === t.indexOf("image://") ? Pi(t.slice(8), new Xt(e, n, i, r), a ? "center" : "cover") : 0 === t.indexOf("path://") ? ki(t.slice(7), {}, new Xt(e, n, i, r), a ? "center" : "cover") : new iw({
            shape: {
                symbolType: t,
                x: e,
                y: n,
    ...
    function dl(t, e, n) {
        ...
        var s = t[0];
        return cl(r[0], s[0]) && cl(r[1], s[1]) || (i += ui(r[0], r[1], s[0], s[1], e, n)), 0 !== i
    }
    ...
    function pl(t) {
        ...
        for (var n = t.features, i = 0; i < n.length; i++)
            for (var r = n[i].geometry, o = r.coordinates, a = r.encodeOffsets, s = 0; s < o.length; s++) {
                var l = o[s];
                if ("Polygon" === r.type) o[s] = gl(l, a[s], e);
    ...
    function ml(t) {
        return "category" === t.type ? yl(t) : _l(t)
    }
    ...
    function yl(t) {
        ...
        if (r) return r;
        var o, a;
        return o = !e.get("show") || t.scale.isBlank() ? [] : x(i) ? Dl(t, i) : Tl(t, a = "auto" === i ? Ml(t) : i), Sl(n, i, {
            labels: o,
    ...
    function xl(t, e) {
        ...
        if (r) return r;
        var o, a = i;
        if (e.get("show") && !t.scale.isBlank() || (o = []), x(a)) o = Dl(t, a, !0);
        else {
            if ("auto" === a) {
                var s = yl(t);
                null != (a = s.labelCategoryInterval) ? o = f(s.labels, function(t) {
                    return t.tickValue
                }) : a = Ml(t, !0)
            }
            null == o && (o = Tl(t, a, !0))
    ...
    function Ml(t, e) {
        var n = e ? "tickAutoInterval" : "autoInterval",
            i = lw(t)[n];
        return null != i ? i : lw(t)[n] = t.calculateCategoryInterval(e)
    }

    function Il(t, e) {
        var n = Cl(t),
            i = ol(t),
            r = (n.axisRotate - n.labelRotate) / 180 * Math.PI,
            o = t.scale,
            a = o.getExtent(),
            s = o.count();
        if (a[1] - a[0] < 1) return 0;
        var l = 1;
        s > 40 && (l = Math.max(1, Math.floor(s / 40)));
        for (var h = a[0], u = t.dataToCoord(h + 1) - t.dataToCoord(h), c = Math.abs(u * Math.cos(r)), d = Math.abs(u * Math.sin(r)), f = 0, p = 0; h <= a[1]; h += l) {
            var g = 0,
                m = 0;
            if (!e) {
                var v = ce(i(h), n.font, "center", "top");
                g = 1.3 * v.width, m = 1.3 * v.height
            }
            f = Math.max(f, g, 7), p = Math.max(p, m, 7)
        }
        var y = f / c,
            x = p / d;
        isNaN(y) && (y = 1 / 0), isNaN(x) && (x = 1 / 0);
        var _ = Math.max(0, Math.floor(Math.min(y, x))),
            w = lw(t.model),
            b = w.lastAutoInterval,
            S = w.lastTickCount;
        return null != b && null != S && Math.abs(b - _) <= 1 && Math.abs(S - s) <= 1 && b > _ ? _ = b : (w.lastTickCount = s, w.lastAutoInterval = _), _
    }
    ...
    function Nl(t) {
        this.group = new Sg, this._symbolCtor = t || Ol
    }
    ...
    function Fl(t, e, n) {
        ...
        return (i |= Ps(e, d[0], d[1])) && (d[0] = p), (i |= Ps(e, d[1], d[0])) && (d[1] = p), {
            dataDimsForPoint: d,
            valueStart: a,
            valueAxisDim: l,
            baseAxisDim: s,
    ...
    function Ul(t, e, n, i, r, o, a, s, l, h, u) {
        return null == h ? Xl(e, "x") ? jl(t, e, n, i, r, o, a, s, l, "x", u) : Xl(e, "y") ? jl(t, e, n, i, r, o, a, s, l, "y", u) : Yl.apply(this, arguments) : "none" !== h && Xl(e, h) ? jl.apply(this, arguments) : Yl.apply(this, arguments)
    }
    ...
    function jl(t, e, n, i, r, o, a, s, l, h, u) {
    ...
    function Yl(t, e, n, i, r, o, a, s, l, h, u) {
        for (var c = 0, d = n, f = 0; f < i; f++) {
            var p = e[d];
            if (d >= r || d < 0) break;
            if (Zl(p)) {
            ...
            if (d === n) t[o > 0 ? "moveTo" : "lineTo"](p[0], p[1]), Mw(Cw, p);
            else if (l > 0) {
                var g = d + o,
                    m = e[g];
                if (u)
                    for (; m && Zl(e[g]);) m = e[g += o];
                var v = .5,
                    y = e[c];
                if (!(m = e[g]) || Zl(m)) Mw(Tw, p);
                else {
                    Zl(m) && !u && (m = p), W(Iw, m, y);
                    var x, _;
                    if ("x" === h || "y" === h) {
                    ...
                    } else x = Vp(p, y), _ = Vp(p, m);
                    Sw(Tw, p, Iw, -l * (1 - (v = _ / (_ + x))))
                }
                ww(Cw, Cw, s), bw(Cw, Cw, a), ww(Tw, Tw, s), bw(Tw, Tw, a), t.bezierCurveTo(Cw[0], Cw[1], Tw[0], Tw[1], p[0], p[1]), Sw(Cw, p, Iw, l * v)
            } else t.lineTo(p[0], p[1]);
            c = d, d += o
        }
        return f
    ...
    function Jl(t, e, n) {
        ...
        for (var i = [], r = 0, o = e.count(); r < o; r++) i.push(Gl(n, t, e, r));
        return i
    }
    ...
    function nh(t, e, n, i) {
        return "polar" === t.type ? eh(t, e, n, i) : th(t, e, n, i)
    }
    ...
    function ah(t, e) {
        ...
        for (var r = e.count(), o = Math.max(1, Math.round(r / 5)), a = 0; a < r; a += o)
            if (1.5 * Ol.getSymbolSize(e, a)[t.isHorizontal() ? 1 : 0] > i) return !1;
        return !0
    }
    ...
    function fh(t) {
        return t && "category" !== t.type && "time" !== t.type && rl(t)
    }
    ...
    function yh(t, e, n, i) {
        ...
        return Dr(a - Zw / 2) ? (o = l ? "bottom" : "top", r = "center") : Dr(a - 1.5 * Zw) ? (o = l ? "top" : "bottom", r = "center") : (o = "middle", r = a < 1.5 * Zw && a > Zw / 2 ? l ? "left" : "right" : l ? "right" : "left"), {
            rotation: a,
            textAlign: r,
            textVerticalAlign: o
        }
    ...
    function _h(t, e, n) {
        ...
        var o = e[0],
            ...
            c = n[n.length - 1],
            d = n[n.length - 2];
        !1 === i ? (wh(o), wh(h)) : bh(o, a) && (i ? (wh(a), wh(u)) : (wh(o), wh(h))), !1 === r ? (wh(s), wh(c)) : bh(l, s) && (r ? (wh(l), wh(d)) : (wh(s), wh(c)))
    }
    ...
    function Ih(t, e, n) {
        ...
        if (C(n.axisLabelShow, e.get("axisLabel.show")) && !i.scale.isBlank()) {
            var r = e.getModel("axisLabel"),
                o = r.get("margin"),
                a = i.getViewLabels(),
                s = (C(n.labelRotate, r.get("rotate")) || 0) * Zw / 180,
                l = jw(n.rotation, s, n.labelDirection),
                h = e.getCategories(!0),
                u = [],
                c = xh(e),
            ...
            return d(a, function(a, s) {
                var d = a.tickValue,
                    ...
                    g = a.rawLabel,
                    m = r;
                h && h[d] && h[d].textStyle && (m = new pr(h[d].textStyle, r, e.ecModel));
                ...
                }), f && (x.eventData = vh(e), x.eventData.targetType = "axisLabel", x.eventData.value = g), t._dumbGroup.add(x), x.updateTransform(), u.push(x), t.group.add(x), x.decomposeTransform()
            }), u
        }
    }
    ...
    function Ch(t, e) {
        ...
        return Th(n, t, e), n.seriesInvolved && Ah(n, t), n
    }
        ...
        Yw(n.getCoordinateSystems(), function(n) {
            function s(i, s, l) {
                ...
                if (d && ("auto" !== d || i || Eh(c))) {
                    ...
                    var f = (c = i ? Dh(l, u, r, e, i, s) : c).get("snap"),
                        p = Nh(l.model),
            ...
            if (n.axisPointerEnabled) {
                ...
                if (Yw(n.getAxes(), qw(s, !1, null)), n.getTooltipAxes && i && u.get("show")) {
    ...
    function Ah(t, e) {
        e.eachSeries(function(e) {
            ...
            n && "none" !== i && !1 !== i && "item" !== i && !1 !== r && !1 !== e.get("axisPointer.show", !0) && Yw(t.coordSysAxesInfo[Nh(n.model)], function(t) {
                var i = t.axis;
    ...
    function kh(t, e) {
        for (var n = e.model, i = e.dim, r = 0; r < t.length; r++) {
            var o = t[r] || {};
            if (Ph(o[i + "AxisId"], n.id) || Ph(o[i + "AxisIndex"], n.componentIndex) || Ph(o[i + "AxisName"], n.name)) return r
        }
    }
    ...
    function Rh(t, e, n, i, r, o) {
        ...
        if (a) {
            var s = zh(e);
            s ? (t._axisPointer || (t._axisPointer = new a)).render(e, s, i, o) : Bh(t, i)
        }
    }
    ...
    function Zh(t, e, n, i, r, o, s, l) {
        ...
        l || Fh(t.style, d, i, h, o, n, p), qi(t, d)
    }
    ...
    function Yh(t, e, n, i) {
        ...
        i.dispatchAction({
            ...
            qh(r.getItemGraphicEl(t), r.getItemLayout(t), e.isSelected(r.getName(t)), s, n)
        })
    }
    ...
    function Qh(t, e, n, i, r, o) {
        ...
        Kh(s, e, n, i, 1, r, o), Kh(a, e, n, i, -1, r, o);
    ...
    function tu(t, e, n, i) {
        var r = n.type,
            o = new(0, Jv[r.charAt(0).toUpperCase() + r.slice(1)])(n);
    ...
    function nu(t) {
        return t = o({}, t), d(["id", "parentId", "$action", "hv", "bounding"].concat(xy), function(e) {
            delete t[e]
        }), t
    }
    ...
    function au(t, e) {
        t && (t.hv = e.hv = [iu(e, ["left", "right"]), iu(e, ["top", "bottom"])], "group" === t.type && (null == t.width && (t.width = e.width = 0), null == t.height && (t.height = e.height = 0)))
    }
    ...
    function lu(t, e) {
        ...
        return yb(e.seriesModels, function(e, l) {
            ...
            if (null != h && isFinite(h)) {
                var f = t - h,
                    p = Math.abs(f);
                p <= a && ((p < a || f >= 0 && s < 0) && (a = p, s = f, r = h, o.length = 0), yb(u, function(t) {
                    o.push({
    ...
    function fu(t, e, n) {
        var i = n.getZr(),
            r = _b(i).axisPointerLastHighlights || {},
            o = _b(i).axisPointerLastHighlights = {};
        yb(t, function(t, e) {
    ...
    function vu(t, e, n) {
        if (!wp.node) {
            var i = e.getZr();
            wb(i).records || (wb(i).records = {}), yu(i, e), (wb(i).records[t] || (wb(i).records[t] = {})).handler = n
        }
    }
    ...
    function yu(t, e) {
        ...
        wb(t).initialized || (wb(t).initialized = !0, n("click", v(wu, "click")), n("mousemove", v(wu, "mousemove")), n("globalout", _u))
    }
    ...
    function Iu(t, e, n, i) {
        Cu(Mb(n).lastProp, i) || (Mb(n).lastProp = i, e ? ar(n, i, t) : (n.stopAnimation(), n.attr(i)))
    }
    ...
    function Pu(t, e, n, i, r) {
        var o = Ou(n.get("value"), e.axis, e.ecModel, n.get("seriesDataIndices"), {
                precision: n.get("label.precision"),
                formatter: n.get("label.formatter")
            }),
            a = n.getModel("label"),
            s = uy(a.get("padding") || 0),
            l = a.getFont(),
            h = ce(o, l),
            u = r.position,
            c = h.width + s[1] + s[3],
        ...
        "bottom" === p && (u[1] -= d), "middle" === p && (u[1] -= d / 2), Lu(u, c, d, i);
    ...
    function Eu(t, e, n, i, r, o) {
        ...
        n.labelMargin = r.get("label.margin"), Pu(e, i, r, o, {
            position: zu(i.axis, t, n),
            align: a.textAlign,
    ...
    function Hu(t) {
        var e = [],
            n = t.get("fontSize"),
            i = t.getTextColor();
        return i && e.push("color:" + i), e.push("font:" + t.getFont()), n && e.push("line-height:" + Math.round(3 * n / 2) + "px"), Ab(["decoration", "align"], function(n) {
            var i = t.get(n);
            i && e.push("text-" + n + ":" + i)
        }), e.join(";")
    }
    ...
    function Gu(t) {
        var e = [],
            ...
            o = t.get("padding");
        return n && e.push(Fu(n)), i && (wp.canvasSupported ? e.push("background-Color:" + i) : (e.push("background-Color:#" + Dt(i)), e.push("filter:alpha(opacity=70)"))), Ab(["width", "color", "radius"], function(n) {
            var i = "border-" + n,
                r = kb(i),
                o = t.get(r);
            null != o && e.push(i + ":" + o + ("color" === n ? "" : "px"))
        }), e.push(Hu(r)), null != o && e.push("padding:" + uy(o).join("px ") + "px"), e.join(";") + ";"
    }

    function Wu(t, e) {
        if (wp.wxa) return null;
        var n = document.createElement("div"),
            i = this._zr = e.getZr();
    ...
    function Qu(t, e, n) {
        var i = e.getBoxLayoutParams(),
            ...
            a = Gr(i, o, r);
        wy(e.get("orient"), t, e.get("itemGap"), a.width, a.height), Wr(t, i, o, r)
    }

    function Ju(t, e) {
        var n = uy(e.get("padding")),
    ...
    function sc(t, e, n, i, r, o) {
        var a = [],
            s = Ps(e, i, n) ? e.getCalculationInfo("stackResultDimension") : i,
            l = fc(e, s, t),
    ...
    function lc(t, e) {
        ...
        if (e && !ac(e) && !y(e.coord) && r) {
            var o = r.dimensions,
                a = hc(e, i, r, t);
            if ((e = n(e)).type && Kb[e.type] && a.baseAxis && a.valueAxis) {
                var s = qb(o, a.baseAxis.dim),
                    l = qb(o, a.valueAxis.dim);
                e.coord = Kb[e.type](i, a.baseDataDim, a.valueDataDim, s, l), e.value = e.coord[l]
            } else {
                for (var h = [null != e.xAxis ? e.xAxis : e.radiusAxis, null != e.yAxis ? e.yAxis : e.angleAxis], u = 0; u < 2; u++) Kb[h[u]] && (h[u] = fc(i, i.mapDimension(o[u]), h[u]));
                e.coord = h
            }
        }
        return e
    ...
    function hc(t, e, n, i) {
        var r = {};
        return null != t.valueIndex || null != t.valueDim ? (r.valueDataDim = null != t.valueIndex ? e.getDimension(t.valueIndex) : t.valueDim, r.valueAxis = n.getAxis(uc(i, r.valueDataDim)), r.baseAxis = n.getOtherAxis(r.valueAxis), r.baseDataDim = e.mapDimension(r.baseAxis.dim)) : (r.baseAxis = i.getBaseAxis(), r.valueAxis = n.getOtherAxis(r.baseAxis), r.baseDataDim = e.mapDimension(r.baseAxis.dim), r.valueDataDim = e.mapDimension(r.valueAxis.dim)), r
    }
    ...
    function cc(t, e) {
        return !(t && t.containData && e.coord && !oc(e)) || t.containData(e.coord)
    }
    ...
    function gc(t, e, n) {
        ...
        var r = new b_(i, n),
            o = f(n.get("data"), v(lc, e));
        return t && (o = g(o, v(cc, t))), r.initData(o, null, t ? dc : function(t) {
            return t.value
        }), r
    }
    ...
    function yc(t, e, n) {
        ...
        if (r && "none" !== r) {
            y(o) || (o = [o, o]);
            var a = ul(r, -o[0] / 2, -o[1] / 2, o[0], o[1], i);
            return a.name = t, a
        }
    }
    ...
    function bc(t) {
        this._ctor = t || wc, this.group = new Sg
    }

    function Sc(t, e, n, i) {
        if (Tc(e.getItemLayout(n))) {
    ...
    function Mc(t, e, n, i, r, o) {
        ...
        Tc(n.getItemLayout(r)) ? (a ? a.updateData(n, r, o) : a = new t._ctor(n, r, o), n.setItemGraphicEl(r, a), t.group.add(a)) : t.group.remove(a)
    }
    ...
    function Ac(t, e, n, i) {
        var r = 1 - t,
            o = i.dimensions[t];
        return Dc(e[r]) && Dc(n[r]) && e[t] === n[t] && i.getAxis(o).containData(e[t])
    }
    ...
    function kc(t, e) {
        if ("cartesian2d" === t.type) {
            var n = e[0].coord,
                i = e[1].coord;
            if (n && i && (Ac(1, n, i, t) || Ac(0, n, i, t))) return !0
        }
        return cc(t, e[0]) && cc(t, e[1])
    }
        ...
        if (isNaN(l) || isNaN(h)) {
            ...
            if ("cartesian2d" === a.type) {
                var f = a.getAxis("x"),
                    p = a.getAxis("y"),
                    u = a.dimensions;
                Dc(t.get(u[0], e)) ? o[0] = f.toGlobalCoord(f.getExtent()[n ? 0 : 1]) : Dc(t.get(u[1], e)) && (o[1] = p.toGlobalCoord(p.getExtent()[n ? 0 : 1]))
            }
    ...
    function Lc(t, e, n) {
        ...
        var r = new b_(i, n),
            o = new b_(i, n),
            s = new b_([], n),
            l = f(n.get("data"), v(oS, e, t, n));
        t && (l = g(l, v(kc, t)));
        var h = t ? dc : function(t) {
            return t.value
        };
    ...
    function zc(t, e, n, i) {
        var r = 1 - t;
        return Oc(e[r]) && Oc(n[r])
    }

    function Ec(t, e) {
        var n = e.coord[0],
            i = e.coord[1];
        return !("cartesian2d" !== t.type || !n || !i || !zc(1, n, i, t) && !zc(0, n, i, t)) || (cc(t, {
            coord: n,
            x: e.x0,
            y: e.y0
        }) || cc(t, {
        ...
        if (isNaN(l) || isNaN(h)) {
            ...
            if ("cartesian2d" === a.type) {
                var c = a.getAxis("x"),
                    ...
                    f = t.get(n[0], e),
                    p = t.get(n[1], e);
                Oc(f) ? o[0] = c.toGlobalCoord(c.getExtent()["x0" === n[0] ? 0 : 1]) : Oc(p) && (o[1] = d.toGlobalCoord(d.getExtent()["y0" === n[1] ? 0 : 1]))
            }
            isNaN(l) || (o[0] = l), isNaN(h) || (o[1] = h)
        } else o = [l, h];
        return o
    ...
    function Fc(t, e, n) {
        var i = [1 / 0, -1 / 0];
        return uS(n, function(t) {
            var n = t.getData();
            n && uS(n.mapDimension(e, !0), function(t) {
    ...
    function td(t) {
        ...
        var e = m,
            ...
            s = e(rd, this),
            l = e(od, this);
        Wp.call(this), this.setPointerChecker = function(t) {
    ...
    function nd(t) {
        if (!sn(t) && sd(this, "moveOnMouseMove", t) && this._dragging && "pinch" !== t.gestureEvent && !Qc(this._zr, "globalPan")) {
            var e = t.offsetX,
                n = t.offsetY,
                i = this._x,
                r = this._y,
    ...
    function rd(t) {
        if (sd(this, "zoomOnMouseWheel", t) && 0 !== t.wheelDelta) {
            var e = t.wheelDelta > 0 ? 1.1 : 1 / 1.1;
            ad.call(this, t, e, t.offsetX, t.offsetY)
        }
    }

    function od(t) {
        if (!Qc(this._zr, "globalPan")) {
            var e = t.pinchScale > 1 ? 1.1 : 1 / 1.1;
            ad.call(this, t, e, t.pinchX, t.pinchY)
        }
    }
    ...
    function ld(t, e) {
        ...
        o || ((o = n[r] = {
            ...
            dataZoomInfos: {},
            count: 0
        }).controller = dd(t, o), o.dispatchAction = v(vd, t)), !o.dataZoomInfos[i] && o.count++, o.dataZoomInfos[i] = e;
        var a = yd(o.dataZoomInfos);
        o.controller.enable(a.controlType, a.opt), o.controller.setPointerChecker(e.containsPoint), ua(o, "dispatchAction", e.throttleRate, "fixRate")
    }
    ...
    function dd(t, e) {
        ...
        return n.on("pan", DS(pd, e)), n.on("zoom", DS(gd, e)), n
    }
    ...
    function Td(t) {
        var e = Md(t);
        return {
            value: g([Id(e.seriesGroupByCategoryAxis), Cd(e.other)], function(t) {
                return t.replace(/[\n\t\s]/g, "")
            }).join("\n\n" + HS + "\n\n"),
            meta: e.meta
        }
    ...
    function kd(t) {
        for (var e = t.split(/\n+/g), n = [], i = f(Dd(e.shift()).split(WS), function(t) {
                return {
                    name: t,
                    data: []
                }
            }), r = 0; r < e.length; r++) {
            var o = Dd(e[r]).split(WS);
            n.push(o.shift());
    ...
    function Pd(t) {
        for (var e = t.split(/\n+/g), n = Dd(e.shift()), i = [], r = 0; r < e.length; r++) {
            var o, a = Dd(e[r]).split(WS),
                s = "",
                l = !1;
    ...
    function Ed(t) {
        Wp.call(this), this._zr = t, this.group = new Sg, this._brushType, this._brushOption, this._panels, this._track = [], this._dragging, this._covers = [], this._creatingCover, this._creatingPanel, this._enableGlobalPan, this._uid = "brushController_" + iM++, this._handlers = {}, US(rM, function(t, e) {
    ...
    function Nd(t, e) {
        var r = t._zr;
        t._enableGlobalPan || $c(r, JS, t._uid), US(t._handlers, function(t, e) {
            r.on(e, t)
        }), t._brushType = e.brushType, t._brushOption = i(n(nM), e, !0)
    }

    function Rd(t) {
        var e = t._zr;
        Kc(e, JS, t._uid), US(t._handlers, function(t, n) {
            e.off(n, t)
    ...
    function Bd(t, e) {
        ...
        return n.__brushOption = e, Hd(n, e), t.group.add(n), n
    }

    function Vd(t, e) {
        var n = Wd(e);
        return n.endCreating && (n.endCreating(t, e), Hd(e, e.__brushOption)), e
    }

    function Fd(t, e) {
        var n = e.__brushOption;
        Wd(e).updateCoverShape(t, e, n.range, n)
    }
    ...
    function Kd(t, e, n, i) {
        var r = i.brushStyle.lineWidth || 0,
            ...
            m = p + r,
            v = g + r;
        Jd(t, e, "main", a, s, p, g), i.transformable && (Jd(t, e, "w", l, h, o, v), Jd(t, e, "e", d, h, o, v), Jd(t, e, "n", l, h, m, o), Jd(t, e, "s", l, f, m, o), Jd(t, e, "nw", l, h, o, o), Jd(t, e, "ne", d, h, o, o), Jd(t, e, "sw", l, f, o, o), Jd(t, e, "se", d, f, o, o))
    }
    ...
    function Jd(t, e, n, i, r, o, a) {
        var s = e.childOfName(n);
        s && s.setShape(hf(lf(t, e, [
            [i, r],
            [i + o, r + a]
        ])))
    }
    ...
    function rf(t, e) {
        if (e.length > 1) return ("e" === (i = [rf(t, (e = e.split(""))[0]), rf(t, e[1])])[0] || "w" === i[0]) && i.reverse(), i.join("");
        var n = {
                left: "w",
                right: "e",
                top: "n",
    ...
    function of (t, e, n, i, r, o, a, s) {
        ...
        US(r.split(""), function(t) {
            var e = tM[t];
            h[e[0]][e[1]] += u[e[0]]
        }), l.range = e(ef(h[0][0], h[1][0], h[0][1], h[1][1])), Gd(n, i), jd(n, {
            isEnd: !1
        })
    }
    ...
    function ff(t, e, i, r) {
        var o, a = t._creatingCover,
            s = t._creatingPanel,
            l = t._brushOption;
        if (t._track.push(i.slice()), Yd(t) || a) {
            if (s && !a) {
                "single" === l.brushMode && Xd(t);
                var h = n(l);
                h.brushType = pf(h.brushType, s), h.panelId = !0 === s ? null : s.panelId, a = t._creatingCover = Bd(t, h), t._covers.push(a)
            }
            if (a) {
                var u = oM[pf(t._brushType, s)];
                a.__brushOption.range = u.getCreatingRange(lf(t, a, t._track)), r && (Vd(t, a), u.updateCommon(t, a)), Fd(t, a), o = {
                    isEnd: r
                }
            }
        } else r && "single" === l.brushMode && l.removeOnClick && Zd(t, e, i) && Xd(t) && (o = {
            isEnd: r,
            removeOnClick: !0
        });
        return o
    ...
    function gf(t) {
        if (this._dragging) {
            cf(t);
            var e = ff(this, t, this.group.transformCoordToLocal(t.offsetX, t.offsetY), !0);
            this._dragging = !1, this._track = [], this._creatingCover = null, e && jd(this, e)
        }
    }
    ...
    function _f(t, e, n) {
        return t = wf(t),
            function(i, r, o) {
                return t.contain(r[0], r[1]) && !vf(i, e, n)
            }
    }
    ...
    function zf(t, e, n) {
        (this._brushController = new Ed(n.getZr())).on("brush", m(this._onBrush, this)).mount(), this._isZoomActive
    }
    ...
    function Zf(t) {
        return document.createElementNS(uI, t)
    }
    ...
    function qf(t, e) {
        e && $f(t, "transform", "matrix(" + dI.call(e, ",") + ")")
    }
    ...
    function Jf(t) {
        for (var e = [], n = t.data, i = t.len(), r = 0; r < i;) {
            ...
            switch (n[r++]) {
                ...
                case cI.A:
                    var s = n[r++],
                        ...
                        m = Xf(g - yI) && !Xf(g),
                        v = !1;
                    v = g >= yI || !Xf(g) && (d > -vI && d < 0 || d > vI) == !!p;
                    var y = Uf(s + h * mI(c)),
                        x = Uf(l + u * gI(c));
                    m && (d = p ? yI - 1e-4 : 1e-4 - yI, v = !0, 9 === r && e.push("M", y, x));
                    var _ = Uf(s + h * mI(c + d)),
                        w = Uf(l + u * gI(c + d));
                    e.push("A", Uf(h), Uf(u), pI(f * xI), +v, +p, _, w);
                    break;
                case cI.Z:
                    o = "Z";
                    break;
            ...
            o && e.push(o);
            for (var M = 0; M < a; M++) e.push(Uf(n[r++]))
        }
        return e.join(" ")
    }
    ...
    function op(t, e) {
        rp.call(this, t, e, ["linearGradient", "radialGradient"], "__gradient_in_use__")
    }

    function ap(t, e) {
        rp.call(this, t, e, "clipPath", "__clippath_in_use__")
    }

    function sp(t, e) {
        rp.call(this, t, e, ["filter"], "__filter_in_use__", "_shadowDom")
    }
    ...
    function up(t) {
        return t instanceof xi ? wI : t instanceof je ? bI : t instanceof Av ? SI : wI
    }
    ...
    var yp = 2311,
        ...
        _p = {},
        wp = _p = "object" == typeof wx && "function" == typeof wx.getSystemInfoSync ? {
            browser: {},
            os: {},
            node: !1,
            wxa: !0,
        ...
        Pp = {},
        Lp = function() {
            return Pp.createCanvas()
        };
    Pp.createCanvas = function() {
        return document.createElement("canvas")
    };
    var Op, zp = "__ec_primitive__";
    E.prototype = {
        constructor: E,
        get: function(t) {
    ...
    var Up = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
        Xp = function(t, e, n, i) {
            Wp.call(this), this.storage = t, this.painter = e, this.painterRoot = i, n = n || new nt, this.proxy = null, this._hovered = {}, this._lastTouchMoment, this._lastX, this._lastY, J.call(this), this.setHandlerProxy(n)
        };
    Xp.prototype = {
        constructor: Xp,
        setHandlerProxy: function(t) {
            this.proxy && this.proxy.dispose(), t && (d(Up, function(e) {
        ...
        findHover: function(t, e, n) {
            for (var i = this.storage.getDisplayList(), r = {
                ...
                var a;
                if (i[o] !== n && !i[o].ignore && (a = it(i[o], t, e)) && (!r.topTarget && (r.topTarget = i[o]), a !== Zp)) {
                    r.target = i[o];
                    break
                }
            }
    ...
    Qp.transform = null, Qp.needLocalTransform = function() {
        ...
        var t = this.parent,
            ...
            i = this.transform;
        n || e ? (i = i || rt(), n ? this.getLocalTransform(i) : qp(i), e && (n ? st(i, t.transform, i) : at(i, t.transform)), this.transform = i, this.invTransform = this.invTransform || rt(), ct(this.invTransform, i)) : i && qp(i)
    }, Qp.getLocalTransform = function(t) {
        return Kp.getLocalTransform(this, t)
    ...
    Qp.decomposeTransform = function() {
        if (this.transform) {
            var t = this.parent,
                e = this.transform;
            t && t.transform && (st(Jp, t.invTransform, e), e = Jp);
        ...
        var n = [t, e],
            i = this.transform;
        return i && $(n, n, i), n
    }, Kp.getLocalTransform = function(t, e) {
        qp(e = e || []);
        var n = t.origin,
            i = t.scale || [1, 1],
            r = t.rotation || 0,
    ...
    var tg = {
        ...
        bounceInOut: function(t) {
            return t < .5 ? .5 * tg.bounceIn(2 * t) : .5 * tg.bounceOut(2 * t - 1) + .5
        }
    };
    ft.prototype = {
        constructor: ft,
    ...
    og.put = function(t, e) {
        ...
        if (null == i[t]) {
            ...
            a ? a.value = e : a = new ig(e), a.key = t, n.insertEntry(a), i[t] = a
        }
        return r
    }, og.get = function(t) {
        var e = this._map[t],
    ...
    var ag = {
        ...
        cg = (Object.freeze || Object)({
            ...
            modifyHSL: function(t, e, n, i) {
                if (t = Mt(t)) return t = Ct(t), null != e && (t[0] = gt(e)), null != n && (t[1] = yt(n)), null != i && (t[2] = yt(i)), Lt(It(t), "rgba")
            },
            modifyAlpha: Pt,
            stringify: Lt
        }),
    ...
    var xg = function(t) {
        Kp.call(this, t), Wp.call(this, t), yg.call(this, t), this.id = t.id || xp()
    };
    xg.prototype = {
        type: "element",
        name: "",
    ...
    Xt.prototype = {
        ...
        union: function(t) {
            var e = wg(t.x, this.x),
                n = wg(t.y, this.y);
            this.width = bg(t.x + t.width, this.x + this.width) - e, this.height = bg(t.y + t.height, this.y + this.height) - n, this.x = e, this.y = n
        },
        applyTransform: function() {
            ...
            return function(r) {
                if (r) {
                    t[0] = n[0] = this.x, t[1] = i[1] = this.y, e[0] = i[0] = this.x + this.width, e[1] = n[1] = this.y + this.height, _g(t, t, r), _g(e, e, r), _g(n, n, r), _g(i, i, r), this.x = wg(t[0], e[0], n[0], i[0]), this.y = wg(t[1], e[1], n[1], i[1]);
                    var o = bg(t[0], e[0], n[0], i[0]),
                        a = bg(t[1], e[1], n[1], i[1]);
    ...
    Cg.prototype = {
        ...
        updateDisplayList: function(t) {
            ...
            n.length = this._displayListLen, wp.canvasSupported && te(n, ee)
        },
    ...
    var Eg = function(t, e, n) {
        var i;
        n = n || gg, "string" == typeof t ? i = oe(t, e, n) : w(t) && (t = (i = t).id), this.id = t, this.dom = i;
        var r = i.style;
    ...
    Eg.prototype = {
        ...
        clear: function(t, e) {
            ...
            if (a && (this.domBack || this.createBackBuffer(), this.ctxBack.globalCompositeOperation = "copy", this.ctxBack.drawImage(n, 0, 0, r / l, o / l)), i.clearRect(0, 0, r, o), e && "transparent" !== e) {
                var h;
                e.colorStops ? (h = e.__canvasGradient || kg.getGradient(i, e, {
                    x: 0,
                    y: 0,
                    width: r,
                    height: o
                }), e.__canvasGradient = h) : e.image && (h = zg.prototype.getCanvasPattern.call(e, i)), i.save(), i.fillStyle = h || e, i.fillRect(0, 0, r, o), i.restore()
            }
            if (a) {
                var u = this.domBack;
    ...
    jg.prototype = {
        ...
        drawRectText: function(t, e) {
            ...
            if (null != i && (i += ""), Ue(i, n)) {
                ...
                n.transformText ? this.setTransform(t) : r && (Xg.copy(e), Xg.applyTransform(r), e = Xg), ke(this, t, i, n, e), t.restore()
            }
        }
    }, Xe.prototype = {
        constructor: Xe,
    ...
    var Yg = new Xt(0, 0, 0, 0),
        qg = new Xt(0, 0, 0, 0),
        $g = function(t, e, n) {
            this.type = "canvas";
            var i = !t.nodeName || "CANVAS" === t.nodeName.toUpperCase();
            this._opts = n = o({}, n || {}), this.dpr = n.devicePixelRatio || gg, this._singleCanvas = i, this.root = t;
            var r = t.style;
    ...
    $g.prototype = {
        ...
        _doPaintList: function(t, e) {
            ...
            return wp.wxa && d(this._layers, function(t) {
        ...
        getLayer: function(t, e) {
            ...
            return n || ((n = new Eg("zr_" + t, this, this.dpr)).zlevel = t, n.__builtin__ = !0, this._layerConfig[t] && i(n, this._layerConfig[t], !0), e && (n.virtual = e), this.insertLayer(t, n), n.initContext()), n
        },
        insertLayer: function(t, e) {
            var n = this._layers,
                ...
                a = -1,
                s = this._domRoot;
            if (n[t]) vg("ZLevel " + t + " has been used already");
            else if (qe(e)) {
                if (r > 0 && t > i[0]) {
        ...
        _updateLayerStatus: function(t) {
            ...
            for (var n = null, i = 0, r = 0; r < t.length; r++) {
                var o, a = t[r],
                    s = a.zlevel;
                a.incremental ? ((o = this.getLayer(s + .001, this._needsManuallyCompositing)).incremental = !0, i = 1) : o = this.getLayer(s + (i > 0 ? .01 : 0), this._needsManuallyCompositing), o.__builtin__ || vg("ZLevel " + s + " has been used by unkown layer " + o.id), o !== n && (o.__used = !0, o.__startIndex !== r && (o.__dirty = !0), o.__startIndex = r, o.incremental ? o.__drawIndex = -1 : o.__drawIndex = r, e(r), n = o), a.__dirty && (o.__dirty = !0, o.incremental && o.__drawIndex < 0 && (o.__drawIndex = r))
            }
    ...
    var Kg = "undefined" != typeof window && !!window.addEventListener,
        ...
        tm = function(t) {
            t = t || {}, this.stage = t.stage || {}, this.onframe = t.onframe || function() {}, this._clips = [], this._running = !1, this._time, this._pausedTime, this._pauseStart, this._paused = !1, Wp.call(this)
        };
    tm.prototype = {
        constructor: tm,
        addClip: function(t) {
        ...
        animate: function(t, e) {
            var n = new fg(t, (e = e || {}).loop, e.getter, e.setter);
    ...
    var nm = {
        ...
        im = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
        rm = ["touchstart", "touchend", "touchmove"],
        om = {
            pointerdown: 1,
            pointerup: 1,
            pointermove: 1,
        ...
        sm = {
            ...
            touchstart: function(t) {
                (t = rn(this.dom, t)).zrByTouch = !0, this._lastTouchMoment = new Date, cn(this, t, "start"), sm.mousemove.call(this, t), sm.mousedown.call(this, t), dn(this)
            },
            touchmove: function(t) {
                (t = rn(this.dom, t)).zrByTouch = !0, cn(this, t, "change"), sm.mousemove.call(this, t), dn(this)
            },
            touchend: function(t) {
                (t = rn(this.dom, t)).zrByTouch = !0, cn(this, t, "end"), sm.mouseup.call(this, t), +new Date - this._lastTouchMoment < 300 && sm.click.call(this, t), dn(this)
            },
            pointerdown: function(t) {
                sm.mousedown.call(this, t)
            },
            pointermove: function(t) {
                fn(t) || sm.mousemove.call(this, t)
            },
            pointerup: function(t) {
                sm.mouseup.call(this, t)
            },
            pointerout: function(t) {
                fn(t) || sm.mouseout.call(this, t)
            }
        };
    d(["click", "mousedown", "mouseup", "mousewheel", "dblclick", "contextmenu"], function(t) {
        sm[t] = function(e) {
    ...
    var hm = !wp.canvasSupported,
        ...
        dm = function(t, e, n) {
            ...
            var i = this,
                ...
                o = n.renderer;
            if (hm) {
                if (!um.vml) throw new Error("You need to require 'zrender/vml/vml' to support IE8");
                o = "vml"
            } else o && um[o] || (o = "canvas");
            var a = new um[o](e, r, n, t);
            this.storage = r, this.painter = a;
            var s = wp.node || wp.worker ? null : new gn(a.getViewportRoot());
            this.handler = new Xp(r, a, s, a.root), this.animation = new tm({
                stage: {
    ...
    var fm = (Object.freeze || Object)({
        ...
        mm = y,
        vm = "series\0",
        ym = ["fontStyle", "fontWeight", "fontSize", "fontFamily", "rich", "tag", "color", "textBorderColor", "textBorderWidth", "width", "height", "lineHeight", "align", "verticalAlign", "baseline", "shadowColor", "shadowBlur", "shadowOffsetX", "shadowOffsetY", "textShadowColor", "textShadowBlur", "textShadowOffsetX", "textShadowOffsetY", "backgroundColor", "borderColor", "borderWidth", "borderRadius", "padding"],
        xm = 0,
        _m = ".",
        wm = "___EC__COMPONENT__CONTAINER___",
        bm = 0,
        Sm = function(t) {
        ...
        nv = Math.sqrt,
        iv = Math.abs,
        rv = "undefined" != typeof Float32Array,
        ov = function(t) {
    ...
    ov.prototype = {
        ...
        setScale: function(t, e) {
            this._ux = iv(1 / gg / t) || 0, this._uy = iv(1 / gg / e) || 0
        },
        getContext: function() {
            return this._ctx
        },
        ...
        arc: function(t, e, n, i, r, o) {
            return this.addData(jm.A, t, e, n, n, i, r - i, 0, o ? 0 : 1), this._ctx && this._ctx.arc(t, e, n, i, r, o), this._xi = tv(r) * n + t, this._yi = ev(r) * n + t, this
        },
        ...
        appendPath: function(t) {
            ...
            rv && this.data instanceof Float32Array && (this.data = new Float32Array(i + n));
            for (r = 0; r < e; r++)
        ...
        _dashedLineTo: function(t, e) {
            var n, i, r = this._dashSum,
                ...
                p = h,
                g = a.length;
            for (u /= d, c /= d, o < 0 && (o = r + o), f -= (o %= r) * u, p -= o * c; u > 0 && f <= t || u < 0 && f >= t || 0 == u && (c > 0 && p <= e || c < 0 && p >= e);) f += u * (n = a[i = this._dashIdx]), p += c * n, this._dashIdx = (i + 1) % g, u > 0 && f < l || u < 0 && f > l || c > 0 && p < h || c < 0 && p > h || s[i % 2 ? "moveTo" : "lineTo"](u >= 0 ? Qm(f, t) : Jm(f, t), c >= 0 ? Qm(p, e) : Jm(p, e));
            u = f - t, c = p - e, this._dashOffset = -nv(u * u + c * c)
        },
        _dashedBezierTo: function(t, e, n, i, r, o) {
            var a, s, l, h, u, c = this._dashSum,
                ...
                _ = f.length,
                w = 0;
            for (d < 0 && (d = c + d), d %= c, a = 0; a < 1; a += .1) s = v(g, t, n, r, a + .1) - v(g, t, n, r, a), l = v(m, e, i, o, a + .1) - v(m, e, i, o, a), y += nv(s * s + l * l);
            for (; x < _ && !((w += f[x]) > d); x++);
            for (a = (w - d) / y; a <= 1;) h = v(g, t, n, r, a), u = v(m, e, i, o, a), x % 2 ? p.moveTo(h, u) : p.lineTo(h, u), a += f[x] / y, x = (x + 1) % _;
            x % 2 != 0 && p.lineTo(r, o), s = r - h, l = o - u, this._dashOffset = -nv(s * s + l * l)
        },
            ...
            for (var t = this.data, e = 0, n = 0, i = 0, r = 0, o = 0; o < t.length;) {
                ...
                switch (1 == o && (i = e = t[o], r = n = t[o + 1]), a) {
                    case jm.M:
                        ...
                        break;
                    case jm.L:
                        ei(e, n, t[o], t[o + 1], $m, Km), e = t[o++], n = t[o++];
                        break;
                    case jm.C:
                        ni(e, n, t[o++], t[o++], t[o++], t[o++], t[o], t[o + 1], $m, Km), e = t[o++], n = t[o++];
                        break;
                    case jm.Q:
                        ii(e, n, t[o++], t[o++], t[o], t[o + 1], $m, Km), e = t[o++], n = t[o++];
                        break;
                    case jm.A:
                        var s = t[o++],
                            l = t[o++],
                            ...
                            d = t[o++] + c,
                            f = (t[o++], 1 - t[o++]);
                        1 == o && (i = tv(c) * h + s, r = ev(c) * u + l), ri(s, l, h, u, c, d, f, $m, Km), e = tv(d) * h + s, n = ev(d) * u + l;
                        break;
                    case jm.R:
                        ei(i = e = t[o++], r = n = t[o++], i + t[o++], r + t[o++], $m, Km);
                        break;
                    case jm.Z:
                        e = i, n = r
                }
                K(Ym, Ym, $m), Q(qm, qm, Km)
            }
            return 0 === o && (Ym[0] = Ym[1] = qm[0] = qm[1] = 0), new Xt(Ym[0], Ym[1], qm[0] - Ym[0], qm[1] - Ym[1])
        },
            ...
            for (var e, n, i, r, o, a, s = this.data, l = this._ux, h = this._uy, u = this._len, c = 0; c < u;) {
                ...
                switch (1 == c && (e = i = s[c], n = r = s[c + 1]), d) {
                    case jm.M:
                        ...
                        break;
                    case jm.L:
                        o = s[c++], a = s[c++], (iv(o - i) > l || iv(a - r) > h || c === u - 1) && (t.lineTo(o, a), i = o, r = a);
                        break;
                    case jm.C:
                    ...
                    case jm.A:
                        var f = s[c++],
                            ...
                            S = g > m ? m / g : 1,
                            M = v + y;
                        Math.abs(g - m) > .001 ? (t.translate(f, p), t.rotate(x), t.scale(b, S), t.arc(0, 0, w, v, M, 1 - _), t.scale(1 / b, 1 / S), t.rotate(-x), t.translate(-f, -p)) : t.arc(f, p, w, v, M, 1 - _), 1 == c && (e = tv(v) * g + f, n = ev(v) * m + p), i = tv(M) * g + f, r = ev(M) * m + p;
                        break;
                    case jm.R:
    ...
    var av = 2 * Math.PI,
        ...
        cv = [-1, -1, -1],
        dv = [-1, -1],
        fv = zg.prototype.getCanvasPattern,
        pv = Math.abs,
        gv = new ov(!0);
    xi.prototype = {
        constructor: xi,
        ...
        brush: function(t, e) {
            ...
            l ? t.fillStyle = this._fillGradient : u && (t.fillStyle = fv.call(a, t)), h ? t.strokeStyle = this._strokeGradient : c && (t.strokeStyle = fv.call(s, t));
            var f = n.lineDash,
                p = n.lineDashOffset,
                g = !!t.setLineDash,
            ...
            for (r = 0, o = 0; r < l.length;) {
                switch (n = l[r++], o = r, i = 0, n) {
                    ...
                    case f:
                        var g = e[4],
                            m = e[5],
                            v = yv(e[0] * e[0] + e[1] * e[1]),
                            y = yv(e[2] * e[2] + e[3] * e[3]),
                            x = xv(-e[1] / y, e[0] / v);
                ...
                for (a = 0; a < i; a++)(s = vv[a])[0] = l[r++], s[1] = l[r++], $(s, s, e), l[o++] = s[0], l[o++] = s[1]
            }
        },
        wv = ["m", "M", "l", "L", "v", "V", "h", "H", "z", "Z", "c", "C", "q", "Q", "t", "T", "s", "S", "a", "A"],
        bv = Math.sqrt,
        Sv = Math.sin,
        Mv = Math.cos,
        Iv = Math.PI,
    ...
    var kv = xi.extend({
        ...
        Lv = function(t) {
            return wp.browser.ie && wp.browser.version >= 11 ? function() {
        ...
        Gv = xi.extend({
            ...
            buildPath: function(t, e) {
                var n = e.x1,
                    ...
                    h = e.cpy2,
                    u = e.percent;
                0 !== u && (t.moveTo(n, i), null == l || null == h ? (u < 1 && (Qn(n, a, r, u, Hv), a = Hv[1], r = Hv[2], Qn(i, s, o, u, Hv), s = Hv[1], o = Hv[2]), t.quadraticCurveTo(a, s, r, o)) : (u < 1 && (Xn(n, a, l, r, u, Hv), a = Hv[1], l = Hv[2], r = Hv[3], Xn(i, s, h, o, u, Hv), s = Hv[1], h = Hv[2], o = Hv[3]), t.bezierCurveTo(a, s, l, h, r, o)))
            },
            pointAt: function(t) {
    ...
    var Xv = function(t, e, n, i, r, o) {
        this.x = null == t ? 0 : t, this.y = null == e ? 0 : e, this.x2 = null == n ? 1 : n, this.y2 = null == i ? 0 : i, this.type = "linear", this.global = o || !1, Uv.call(this, r)
    };
    Xv.prototype = {
        constructor: Xv
    }, h(Xv, Uv);
    ...
    jv.prototype = {
        constructor: jv
    }, h(jv, Uv), Di.prototype.incremental = !0, Di.prototype.clearDisplaybles = function() {
        ...
        Jv = (Object.freeze || Object)({
            ...
            clipRectByRect: function(t, e) {
                var n = $v(t.x, e.x),
                    ...
                    r = $v(t.y, e.y),
                    o = Kv(t.y + t.height, e.y + e.height);
                if (i >= n && o >= r) return {
                    x: n,
                    y: r,
                    width: i - n,
    ...
    }, En(pr), Nn(pr), ry(pr, Im), ry(pr, Tm), ry(pr, ey), ry(pr, iy);
    var ay = 0,
        sy = 1e-4,
        ...
        yy = d,
        xy = ["left", "right", "top", "bottom", "width", "height"],
        _y = [
            ["width", "left", "right"],
            ["height", "top", "bottom"]
        ],
        wy = Hr,
        by = (v(Hr, "vertical"), v(Hr, "horizontal"), {
    ...
    Vn(My, {
        ...
        function(t, e) {
            ...
            var e = [];
            return d(My.getClassesByMainType(t), function(t) {
    ...
    var By = Dn(),
        ...
        Fy = pr.extend({
            ...
            setOption: function(t, e) {
                P(!(Vy in t), "please use chart.getOption()"), this._optionManager.setOption(t, e), this.resetOption(null)
            },
            ...
            mergeOption: function(t) {
                ...
                Jr(this), d(t, function(t, r) {
                    null != t && (My.hasClass(r) ? r && a.push(r) : e[r] = null == e[r] ? n(t) : i(e[r], t, !0))
                }), My.topologicalTravel(a, My.getAllClassMainTypes(), function(n, i) {
                    var a = xn(t[n]),
                        s = Sn(r.get(n), a);
                    ...
                    e[n] = [], r.set(n, []), d(s, function(t, i) {
                        ...
                        if (P(w(s) || a, "Empty component definition"), s) {
                            var h = My.getClass(n, t.keyInfo.subType, !0);
    ...
    xo.prototype = {
        ...
        mountOption: function(t) {
            ...
            return this._timelineOptions = Uy(e.timelineOptions, Zy), this._mediaList = Uy(e.mediaList, Zy), this._mediaDefault = Zy(e.mediaDefault), this._currentMediaIndices = [], Zy(t ? e.baseOption : this._newBaseOption)
        },
        ...
        getMediaOption: function(t) {
            ...
            return !o.length && r && (o = [-1]), o.length && !So(o, this._currentMediaIndices) && (a = Uy(o, function(t) {
    ...
    var Yy = d,
        qy = w,
        $y = ["areaStyle", "lineStyle", "nodeStyle", "linkStyle", "chordStyle", "label", "labelLine"],
        Ky = function(t, e) {
            Yy(Po(t.series), function(t) {
                qy(t) && ko(t)
            });
            var n = ["xAxis", "yAxis", "radiusAxis", "angleAxis", "singleAxis", "parallelAxis", "radar"];
            e && n.push("valueAxis", "categoryAxis", "logAxis", "timeAxis"), Yy(n, function(e) {
                Yy(Po(t[e]), function(t) {
                    t && (Do(t, "axisLabel"), Do(t.axisPointer, "label"))
                })
            }), Yy(Po(t.parallel), function(t) {
                var e = t && t.parallelAxisDefault;
                Do(e, "axisLabel"), Do(e && e.axisPointer, "label")
            }), Yy(Po(t.calendar), function(t) {
                Co(t, "itemStyle"), Do(t, "dayLabel"), Do(t, "monthLabel"), Do(t, "yearLabel")
            }), Yy(Po(t.radar), function(t) {
                Do(t, "name")
            }), Yy(Po(t.geo), function(t) {
                qy(t) && (Ao(t), Yy(Po(t.regions), function(t) {
                    Ao(t)
                }))
            }), Yy(Po(t.timeline), function(t) {
                Ao(t), Co(t, "label"), Co(t, "itemStyle"), Co(t, "controlStyle", !0);
                var e = t.data;
                y(e) && d(e, function(t) {
                    w(t) && (Co(t, "label"), Co(t, "itemStyle"))
                })
            }), Yy(Po(t.toolbox), function(t) {
                Co(t, "iconStyle"), Yy(t.feature, function(t) {
                    Co(t, "iconStyle")
                })
        ...
        Jy = ["grid", "geo", "parallel", "legend", "toolbox", "title", "visualMap", "dataZoom", "timeline"],
        tx = function(t, e) {
            Ky(t, e), t.series = xn(t.series), d(t.series, function(t) {
                if (w(t)) {
                    var e = t.type;
            ...
            }), t.dataRange && (t.visualMap = t.dataRange), d(Jy, function(e) {
                var n = t[e];
    ...
    var nx = {
        ...
        ax = {
            ...
            getFormattedLabel: function(t, e, n, i, r) {
                ...
                return "function" == typeof l ? (s.status = e, l(s)) : "string" == typeof l ? Nr(l, s).replace(ox, function(e, n) {
                    var i = n.length;
    ...
    sx.perform = function(t) {
        ...
        a === l && s === h || (o = "reset");
        var u;
        (this._dirty || "reset" === o) && (this._dirty = !1, u = qo(this, i)), this._modBy = l, this._modDataCount = h;
        var c = t && t.step;
        if (this._dueEnd = n ? n._outputDueEnd : this._count ? this._count(this.context) : 1 / 0, this._progress) {
            ...
            if (!i && (u || d < f)) {
                ...
                if (y(p))
                    for (var g = 0; g < p.length; g++) Yo(this, p[g], d, f, l, h);
                else Yo(this, p, d, f, l, h)
            }
            this._dueIndex = f;
        ...
        ux = My.extend({
            ...
            mergeDefaultAndTheme: function(t, e) {
                var n = this.layoutMode,
                    r = n ? Ur(t) : {},
                    o = this.subType;
                My.hasClass(o) && (o += "Series"), i(t, e.getTheme().get(this.subType)), i(t, this.getDefaultOption()), _n(t, "label", ["show"]), this.fillDataTextStyle(t.data), n && Zr(t, r, n)
            },
            mergeOption: function(t, e) {
            ...
            getColorFromPalette: function(t, e, n) {
                var i = this.ecModel,
                    r = Dy.getColorFromPalette.call(this, t, e, n);
    ...
    var dx = cx.prototype;
    dx.updateView = dx.updateLayout = dx.updateVisual = function(t, e, n, i) {}, En(cx), Vn(cx, {
        registerWhenExtend: !0
    });
    var fx = function() {
            var t = Dn();
    ...
    Cx.restoreData = function(t, e) {
        ...
        var r = t.renderTask,
            o = r.context;
        o.model = e, o.ecModel = n, o.api = i, r.__block = !t.incrementalPrepareRender, Ma(this, e, r)
    ...
    var Ax, kx = {},
        Px = {};
    Ca(kx, Fy), Ca(Px, vo), kx.eachSeriesByType = kx.eachRawSeriesByType = function(t) {
        Ax = t
    }, kx.eachComponent = function(t) {
        "series" === t.mainType && t.subType && (Ax = t.subType)
    };
    var Lx = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1", "#e7bcf3", "#9d96f5", "#8378EA", "#96BFFF"],
        Ox = {
            color: Lx,
            colorLayer: [
                ["#37A2DA", "#ffd85c", "#fd7b5f"],
                ["#37A2DA", "#67E0E3", "#FFDB5C", "#ff9f7f", "#E062AE", "#9d96f5"],
                ["#37A2DA", "#32C5E9", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#e7bcf3", "#8378EA", "#96BFFF"], Lx
            ]
        },
    ...
    var Nx = P,
        ...
        jx = "__optionUpdated",
        Yx = /^[a-zA-Z0-9_]+$/;
    Da.prototype.on = Ta("on"), Da.prototype.off = Ta("off"), Da.prototype.one = Ta("one"), u(Da, Wp);
    var qx = Aa.prototype;
    qx._onframe = function() {
        if (!this._disposed) {
            ...
            if (this[jx]) {
                ...
                this[Xx] = !0, Pa(this), $x.update.call(this), this[Xx] = !1, this[jx] = !1, Ea.call(this, e), Na.call(this, e)
        ...
        if (Vx(e) && (n = e.lazyUpdate, i = e.silent, e = e.notMerge), this[Xx] = !0, !this._model || e) {
            var r = new xo(this._api),
                o = this._theme,
                a = this._model = new Fy(null, null, o, r);
            a.scheduler = this._scheduler, a.init(null, null, o, r)
        }
        this._model.setOption(t, e_), n ? (this[jx] = {
            silent: i
        }, this[Xx] = !1) : (Pa(this), $x.update.call(this), this._zr.flush(), this[jx] = !1, this[Xx] = !1, Ea.call(this, i), Na.call(this, i))
        ...
        if (wp.canvasSupported) return (t = t || {}).pixelRatio = t.pixelRatio || 1, t.backgroundColor = t.backgroundColor || this._model.get("backgroundColor"), this._zr.painter.getRenderedCanvas(t)
    ...
    }, qx.convertToPixel = v(ka, "convertToPixel"), qx.convertFromPixel = v(ka, "convertFromPixel"), qx.containPixel = function(t, e) {
        var n;
    ...
    var $x = {
        ...
        update: function(t) {
            ...
            if (e) {
                ...
                if (wp.canvasSupported) i.setBackgroundColor(a);
                else {
                    var s = Mt(a);
    ...
    qx.resize = function(t) {
        ...
        if (this._loadingFX && this._loadingFX.resize(), e) {
            var n = e.resetOption("media"),
                i = t && t.silent;
            this[Xx] = !0, n && Pa(this), $x.update.call(this), this[Xx] = !1, Ea.call(this, i), Na.call(this, i)
        }
    }, qx.showLoading = function(t, e) {
        if (Vx(t) && (e = t, t = ""), t = t || "default", this.hideLoading(), o_[t]) {
            var n = o_[t](this._api, e),
                i = this._zr;
        ...
        Vx(e) || (e = {
            silent: !!e
        }), Qx[t.type] && this._model && (this[Xx] ? this._pendingActions.push(t) : (za.call(this, t, e.silent), e.flush ? this._zr.flush(!0) : !1 !== e.flush && wp.browser.weChat && this._throttledZrFlush(), Ea.call(this, e.silent), Na.call(this, e.silent)))
    }, qx.appendData = function(t) {
        var e = t.seriesIndex;
        this.getModel().getSeriesByIndex(e).appendData(t), this._scheduler.unfinished = !0
    }, qx.on = Ta("on"), qx.off = Ta("off"), qx.one = Ta("one");
    ...
    qx._initEvents = function() {
        ...
        if (!this._disposed) {
            this._disposed = !0, Pn(this.getDom(), u_, "");
            var t = this._api,
                e = this._model;
    ...
    var Qx = {},
        ...
        l_ = new Date - 0,
        h_ = new Date - 0,
        u_ = "_echarts_instance_",
        c_ = {},
        d_ = qa;
    ns(2e3, bx), Qa(tx), Ja(5e3, function(t) {
        var e = N();
        t.eachSeries(function(t) {
            var n = t.get("stack");
            if (n) {
    ...
    us.prototype = {
        ...
        execute: function() {
            var t = this._old,
                ...
                i = [],
                r = [];
            for (cs(t, {}, i, "_oldKeyGetter", this), cs(e, n, r, "_newKeyGetter", this), o = 0; o < t.length; o++) null != (s = n[a = i[o]]) ? ((h = s.length) ? (1 === h && (n[a] = null), s = s.unshift()) : n[a] = null, this._update && this._update(s, o)) : this._remove && this._remove(o);
    ...
    var p_ = N(["tooltip", "label", "itemName", "itemId", "seriesName"]),
        g_ = w,
        m_ = "e\0\0",
        v_ = {
        ...
        y_ = "undefined" == typeof Uint32Array ? Array : Uint32Array,
        x_ = "undefined" == typeof Uint16Array ? Array : Uint16Array,
        __ = ["hasItemOption", "_nameList", "_idList", "_invertedIndicesMap", "_rawData", "_chunkSize", "_chunkCount", "_dimValueGetter", "_count", "_rawCount", "_nameDimIdx", "_idDimIdx"],
        w_ = ["_extent", "_approximateExtent", "_rawExtent"],
        b_ = function(t, e) {
            t = t || ["x", "y"];
    ...
    S_.type = "list", S_.hasItemOption = !0, S_.getDimension = function(t) {
        ...
        if (!(t >= e)) {
            for (var n, i = this._chunkSize, r = this._rawData, o = this._storage, a = this.dimensions, s = a.length, l = this._dimensionInfos, h = this._nameList, u = this._idList, c = this._rawExtent, d = this._nameRepeatCount = {}, f = this._chunkCount, p = f - 1, g = 0; g < s; g++) {
                c[C = a[g]] || (c[C] = [1 / 0, -1 / 0]);
                var m = l[C];
            ...
            for (var w = new Array(s), b = t; b < e; b++) {
                ...
                if (!r.pure) {
                    ...
                    null == z && null != k && (d[k] = d[k] || 0, z = k, d[k] > 0 && (z += "__ec__" + d[k]), d[k]++), null != z && (u[b] = z)
                }
        ...
        g_(t) ? o(this._calculationInfo, t) : this._calculationInfo[t] = e
        ...
        if (this._count) {
            ...
            for (var r = (t = f(Ss(t), this.getDimension, this)).length, o = 0; o < this.count(); o++) switch (r) {
                case 0:
                    e.call(n, o);
                    break;
                case 1:
        ...
        if (this._count) {
            "function" == typeof t && (i = n, n = e, e = t, t = []), n = n || i || this, t = f(Ss(t), this.getDimension, this);
            for (var r = this.count(), o = new(gs(this))(r), a = [], s = t.length, l = 0, h = t[0], u = 0; u < r; u++) {
                ...
                if (!this._indices) {
                    ...
                    if (1 === i) {
                        for (var d = this._storage[e[0]], f = 0; f < this._chunkCount; f++)
                            for (var p = d[f], g = Math.min(this._count - f * this._chunkSize, this._chunkSize), m = 0; m < g; m++)((w = p[m]) >= l && w <= h || isNaN(w)) && (o[a++] = c), c++;
                        u = !0
                    } else if (2 === i) {
        ...
        n = n || i || this;
        var r = Ms(this, t = f(Ss(t), this.getDimension, this));
        ...
        for (var r = Ms(this, [t]), o = r._storage, a = [], s = Math.floor(1 / e), l = o[t], h = this.count(), u = this._chunkSize, c = r._rawExtent[t], d = new(gs(this))(h), f = 0, p = 0; p < h; p += s) {
    ...
    Es.prototype.parse = function(t) {
        return t
    }, Es.prototype.getSetting = function(t) {
        return this._setting[t]
    }, Es.prototype.contain = function(t) {
        var e = this._extent;
        return t >= e[0] && t <= e[1]
    }, Es.prototype.normalize = function(t) {
        var e = this._extent;
        return e[1] === e[0] ? .5 : (t - e[0]) / (e[1] - e[0])
    }, Es.prototype.scale = function(t) {
        var e = this._extent;
        return t * (e[1] - e[0]) + e[0]
    }, Es.prototype.unionExtent = function(t) {
        var e = this._extent;
        t[0] < e[0] && (e[0] = t[0]), t[1] > e[1] && (e[1] = t[1])
    }, Es.prototype.unionExtentFromData = function(t, e) {
        this.unionExtent(t.getApproximateExtent(e))
    }, Es.prototype.getExtent = function() {
        return this._extent.slice()
    }, Es.prototype.setExtent = function(t, e) {
        var n = this._extent;
        isNaN(t) || (n[0] = t), isNaN(e) || (n[1] = e)
    }, Es.prototype.isBlank = function() {
        return this._isBlank
    }, Es.prototype.setBlank = function(t) {
        this._isBlank = t
    }, Es.prototype.getLabel = null, En(Es), Vn(Es, {
        registerWhenExtend: !0
    }), Ns.createByAxisModel = function(t) {
        var e = t.option,
            n = e.data,
            i = n && f(n, Bs);
        return new Ns({
    ...
    var A_ = wr,
        ...
        P_ = Es.extend({
            ...
            setInterval: function(t) {
                this._interval = t, this._niceExtent = this._extent.slice(), this._intervalPrecision = Fs(t)
            },
            getTicks: function() {
                return Ws(this._interval, this._extent, this._niceExtent, this._intervalPrecision)
            },
            getLabel: function(t, e) {
                if (null == t) return "";
                var n = e && e.precision;
                return null == n ? n = Mr(t) || 0 : "auto" === n && (n = this._intervalPrecision), t = k_(t, n, !0), Or(t)
            },
    ...
    var L_ = "__ec_stack_",
        O_ = "undefined" != typeof Float32Array ? Float32Array : Array,
        z_ = {
            seriesType: "bar",
            plan: fx(),
            reset: function(t) {
                if ($s(t) && Ks(t)) {
                    ...
                    return h > .5 || (h = .5), {
                        progress: function(t, e) {
                            for (var u, c = new O_(2 * t.count), d = [], f = [], p = 0; null != (u = t.next());) f[l] = e.get(o, u), f[1 - l] = e.get(a, u), d = n.dataToPoint(f, null, d), c[p++] = d[0], c[p++] = d[1];
                            e.setLayout({
                                largePoints: c,
                                barWidth: h,
                                valueAxisStart: Qs(i, r, !1),
        ...
        V_ = P_.extend({
            ...
            niceExtent: function(t) {
                ...
                t.fixMin || (e[0] = wr(R_(e[0] / i) * i)), t.fixMax || (e[1] = wr(N_(e[1] / i) * i))
            },
            niceTicks: function(t, e, n) {
                t = t || 10;
                var i = this._extent,
                ...
                var u = this.getSetting("useUTC") ? 0 : 60 * new Date(+i[0] || +i[1]).getTimezoneOffset() * 1e3,
                    c = [Math.round(N_((i[0] - u) / h) * h + u), Math.round(R_((i[1] - u) / h) * h + u)];
                Gs(c, i), this._stepLvl = l, this._interval = h, this._niceExtent = c
            },
            parse: function(t) {
                return +Ar(t)
            }
    ...
    var H_ = Es.prototype,
        ...
        q_ = Es.extend({
            ...
            $constructor: function() {
                Es.apply(this, arguments), this._originalScale = new P_
            },
            getTicks: function() {
                var t = this._originalScale,
                    e = this._extent,
                    n = t.getExtent();
                return f(G_.getTicks.call(this), function(i) {
                    var r = wr(j_(this.base, i));
                    return r = i === e[0] && t.__fixMin ? Js(r, n[0]) : r, r = i === e[1] && t.__fixMax ? Js(r, n[1]) : r
                }, this)
            },
            ...
            getExtent: function() {
                var t = this.base,
                    e = H_.getExtent.call(this);
                e[0] = j_(t, e[0]), e[1] = j_(t, e[1]);
                var n = this._originalScale,
                    i = n.getExtent();
                return n.__fixMin && (e[0] = Js(e[0], i[0])), n.__fixMax && (e[1] = Js(e[1], i[1])), e
            },
            unionExtent: function(t) {
            ...
            niceTicks: function(t) {
                ...
                if (!(n === 1 / 0 || n <= 0)) {
                    ...
                    var r = [wr(X_(e[0] / i) * i), wr(U_(e[1] / i) * i)];
    ...
    var iw = Ai({
            ...
            buildPath: function(t, e, n) {
                var i = e.symbolType,
                    r = nw[i];
                "none" !== e.symbolType && (r || (r = nw[i = "rect"]), ew[i](e.x, e.y, e.width, e.height, r.shape), r.buildPath(t, r.shape, n))
            }
        }),
        rw = {
        ...
        ow = (Object.freeze || Object)({
            createList: function(t) {
                return Ls(t.getSource(), t)
            },
            getLayoutRect: Gr,
            dataStack: rw,
            createScale: function(t, e) {
                var n = e;
                pr.isInstance(e) || u(n = new pr(e), $_);
                var i = il(n);
                return i.setExtent(t[0], t[1]), nl(i, n), i
            },
    ...
    var sw = function(t) {
            return pl(t), f(g(t.features, function(t) {
    ...
    uw.prototype = {
        ...
        dataToCoord: function(t, e) {
            var n = this._extent,
                i = this.scale;
            return t = i.normalize(t), this.onBand && "ordinal" === i.type && kl(n = n.slice(), i.count()), xr(t, hw, n, e)
        },
        coordToData: function(t, e) {
            var n = this._extent,
                i = this.scale;
            this.onBand && "ordinal" === i.type && kl(n = n.slice(), i.count());
            var r = xr(t, n, hw, e);
        ...
        getTicksCoords: function(t) {
            ...
            return Pl(this, i, n.tickCategoryInterval, r, t.clamp), i
        },
    ...
    var fw = Ol.prototype,
        pw = Ol.getSymbolSize = function(t, e) {
            var n = t.getItemVisual(e, "symbolSize");
            return n instanceof Array ? n.slice() : [+n, +n]
        };
    fw._createSymbol = function(t, e, n, i, r) {
        this.removeAll();
        var o = ul(t, -1, -1, 2, 2, e.getItemVisual(n, "color"), r);
        o.attr({
            z2: 100,
            culling: !0,
            scale: zl(i)
        }), o.drift = El, this._symbolType = t, this.add(o)
        ...
        if (this._updateCommon(t, e, o, n), a) {
            ...
            }), l.scale = [0, 0], h && (l.style.opacity = 0), sr(l, u, r, e)
        }
        this._seriesModel = r
    };
    var gw = ["itemStyle"],
        mw = ["emphasis", "itemStyle"],
        vw = ["label"],
        yw = ["emphasis", "label"];
    fw._updateCommon = function(t, e, n, i) {
        ...
        if (!i || t.hasItemOption) {
            ...
            l = m.getModel(gw).getItemStyle(["color"]), h = m.getModel(mw).getItemStyle(), u = m.getShallow("symbolRotate"), c = m.getShallow("symbolOffset"), d = m.getModel(vw), f = m.getModel(yw), p = m.getShallow("hoverAnimation"), g = m.getShallow("cursor")
        } else h = o({}, h);
        var v = r.style;
    ...
    xw.updateData = function(t, e) {
        ...
        r || n.removeAll(), t.diff(r).add(function(i) {
            ...
            var h = r.getItemGraphicEl(l),
                u = t.getItemLayout(s);
            Rl(t, u, s, e) ? (h ? (h.updateData(t, s, a), ar(h, {
                position: u
        ...
        this._seriesScope = Vl(t), this._data = null, this.group.removeAll()
    ...
    var _w = function(t, e, n, i, r, o, a, s) {
            for (var l = Wl(t, e), h = [], u = [], c = [], d = [], f = [], p = [], g = [], m = Fl(r, e, a), v = Fl(o, t, s), y = 0; y < l.length; y++) {
                var x = l[y],
                    _ = !0;
                switch (x.cmd) {
                    case "=":
                    ...
                    case "+":
                        S = x.idx;
                        h.push(r.dataToPoint([e.get(m.dataDimsForPoint[0], S), e.get(m.dataDimsForPoint[1], S)])), u.push(e.getItemLayout(S).slice()), c.push(Gl(m, r, e, S)), d.push(i[S]), g.push(e.getRawIndex(S));
                        break;
                    case "-":
                        var S = x.idx,
                            M = t.getRawIndex(S);
                        M !== S ? (h.push(t.getItemLayout(S)), u.push(o.dataToPoint([t.get(v.dataDimsForPoint[0], S), t.get(v.dataDimsForPoint[1], S)])), c.push(n[S]), d.push(Gl(v, o, t, S)), g.push(M)) : _ = !1
                }
        ...
        Dw = xi.extend({
            ...
            buildPath: function(t, e) {
                var n = e.points,
                    i = 0,
                    r = n.length,
                    o = ql(n, e.smoothConstraint);
                if (e.connectNulls) {
                    for (; r > 0 && Zl(n[r - 1]); r--);
                    for (; i < r && Zl(n[i]); i++);
                }
                for (; i < r;) i += Ul(t, n, i, r, r, 1, o.min, o.max, e.smooth, e.smoothMonotone, e.connectNulls) + 1
            }
        }),
        Aw = xi.extend({
            type: "ec-polygon",
            ...
            buildPath: function(t, e) {
                var n = e.points,
                    ...
                    o = n.length,
                    a = e.smoothMonotone,
                    s = ql(n, e.smoothConstraint),
                    l = ql(i, e.smoothConstraint);
                if (e.connectNulls) {
                    for (; o > 0 && Zl(n[o - 1]); o--);
                    for (; r < o && Zl(n[r]); r++);
                }
                for (; r < o;) {
                    var h = Ul(t, n, r, o, o, 1, s.min, s.max, e.smooth, a, e.connectNulls);
                    Ul(t, i, r + h - 1, h, o, -1, l.min, l.max, e.stackedOnSmooth, a, e.connectNulls), r += h + 1, t.closePath()
                }
            }
        });
    ra.extend({
        ...
        render: function(t, e, n) {
            ...
            var S = !u && t.get("step");
            f && c.type === i.type && S === this._step ? (v && !p ? p = this._newPolygon(h, x, i, m) : p && !v && (g.remove(p), p = this._polygon = null), g.setClipPath(nh(i, !1, !1, t)), _ && d.updateData(o, {
                isIgnore: w,
                clipShape: nh(i, !1, !0, t)
            }), o.eachItemGraphicEl(function(t) {
                t.stopAnimation(!0)
            }), $l(this._stackedOnPoints, x) && $l(this._points, h) || (m ? this._updateAnimation(o, x, i, n, S, y) : (S && (h = ih(h, i, S), x = ih(x, i, S)), f.setShape({
                points: h
            }), p && p.setShape({
                points: h,
                stackedOnPoints: x
                ...
                isIgnore: w,
                clipShape: nh(i, !1, !0, t)
            }), S && (h = ih(h, i, S), x = ih(x, i, S)), f = this._newPolyline(h, i, m), v && (p = this._newPolygon(h, x, i, m)), g.setClipPath(nh(i, !0, !1, t)));
            var M = rh(o, i) || o.getVisual("color");
            ...
            var I = t.get("smooth");
            if (I = Kl(t.get("smooth")), f.setShape({
                    smooth: I,
                ...
                p.useStyle(a(l.getAreaStyle(), {
                    ...
                    opacity: .7,
                    lineJoin: "bevel"
                })), C && (T = Kl(C.get("smooth"))), p.setShape({
                    smooth: I,
                    stackedOnSmooth: T,
                    smoothMonotone: t.get("smoothMonotone"),
                    connectNulls: t.get("connectNulls")
        ...
        highlight: function(t, e, n, i) {
            ...
            if (!(o instanceof Array) && null != o && o >= 0) {
                ...
                if (!a) {
                    ...
                    if (!s) return;
                    (a = new Ol(r, o)).position = s, a.setZ(t.get("zlevel"), t.get("z")), a.ignore = isNaN(s[0]) || isNaN(s[1]), a.__temp = !0, r.setItemGraphicEl(o, a), a.stopSymbolAnimation(!0), this.group.add(a)
                }
                a.highlight()
        ...
        _updateAnimation: function(t, e, n, i, r, o) {
            var a = this._polyline,
                s = this._polygon,
                l = t.hostModel,
                h = _w(this._data, t, this._stackedOnPoints, e, this._coordSys, n, this._valueOrigin, o),
                u = h.current,
                c = h.stackedOnCurrent,
                d = h.next,
                f = h.stackedOnNext;
            r && (u = ih(h.current, n, r), c = ih(h.stackedOnCurrent, n, r), d = ih(h.next, n, r), f = ih(h.stackedOnNext, n, r)), a.shape.__points = h.current, a.shape.points = u, ar(a, {
                shape: {
                    points: d
                }
            }, l), s && (s.setShape({
            ...
            return {
                ...
                reset: function(t) {
                    ...
                    if (n) {
                        ...
                        return Ps(e, r[0], r[1]) && (r[0] = a), Ps(e, r[1], r[0]) && (r[1] = a), o && {
                            progress: function(t, e) {
    ...
    zw.prototype = {
        ...
        getAxes: function() {
            return f(this._dimList, sh, this)
        },
    ...
    var Ew = function(t, e, n, i, r) {
        uw.call(this, t, e, n), this.type = i || "value", this.position = r || "bottom"
    };
    Ew.prototype = {
        constructor: Ew,
        index: 0,
    ...
    Rw.categoryAxis = i({
        ...
        min: "dataMin",
        max: "dataMax"
    }, Rw.valueAxis), Rw.logAxis = a({
        scale: !0,
        logBase: 10
    }, Rw.valueAxis);
    var Bw = ["value", "category", "time", "log"],
        Vw = function(t, e, n, o) {
            d(Bw, function(a) {
                e.extend({
                    type: t + "Axis." + a,
                    ...
                    optionUpdated: function() {
                        "category" === this.option.type && (this.__ordinalMeta = Ns.createByAxisModel(this))
                    },
                    ...
                    defaultOption: r([{}, Rw[a + "Axis"], o], !0)
                })
            }), My.registerSubTypeDefaulter(t + "Axis", v(n, t))
        },
        Fw = My.extend({
    ...
    Vw("x", Fw, hh, Hw), Vw("y", Fw, hh, Hw), My.extend({
        type: "grid",
        ...
        function i(n) {
            return function(i, s) {
                if (uh(i, t, e)) {
                    ...
                    var h = new Ew(n, il(i), [0, 0], i.get("type"), l),
                        u = "category" === h.type;
    ...
    }, ch.dimensions = ch.prototype.dimensions = lh.prototype.dimensions, yo.register("cartesian2d", ch);
    var Zw = Math.PI,
        Uw = function(t, e) {
    ...
    var Xw = {
                    ...
                    if ("number" == typeof u && (u = [u, u]), null != l) {
                        ...
                        d([{
                            ...
                            if ("none" !== l[n] && null != l[n]) {
                                var i = ul(l[n], -c / 2, -f / 2, c, f, s.stroke, !0),
                                    o = e.r + e.offset,
            ...
            axisName: function() {
                ...
                if (n) {
                    var i, r = e.get("nameLocation"),
                        ...
                        u = h[0] > h[1] ? -1 : 1,
                        c = ["start" === r ? h[0] - u * l : "end" === r ? h[1] + u * l : (h[0] + h[1]) / 2, Sh(r) ? t.labelOffset + a * l : 0],
                        d = e.get("nameRotate");
                    null != d && (d = d * Zw / 180);
                    var f;
                    Sh(r) ? i = jw(t.rotation, null != d ? d : t.rotation, a) : (i = yh(t, r, d || 0, h), null != (f = t.axisNameAvailableWidth) && (f = Math.abs(f / Math.sin(i.rotation)), !isFinite(f) && (f = null)));
                    var p = s.getFont(),
                        g = e.get("nameTruncate", !0) || {},
                        m = g.ellipsis,
                        v = C(t.nameTruncateMaxWidth, g.maxWidth, f),
                        y = null != m && null != v ? gy(n, v, p, m, {
                            minChar: 2,
                    ...
                    }), e.get("triggerEvent") && (b.eventData = vh(e), b.eventData.targetType = "axisName", b.eventData.name = n), this._dumbGroup.add(b), b.updateTransform(), this.group.add(b), b.decomposeTransform()
                }
            }
        },
        jw = Uw.innerTextLayout = function(t, e, n) {
            var i, r, o = Tr(e - t);
            return Dr(o) ? (r = n > 0 ? "top" : "bottom", i = "center") : Dr(o - Zw) ? (r = n > 0 ? "bottom" : "top", i = "center") : (r = "middle", i = o > 0 && o < Zw ? n > 0 ? "right" : "left" : n > 0 ? "left" : "right"), {
                rotation: o,
                textAlign: i,
                textVerticalAlign: r
            }
        ...
        $w = as({
            ...
            render: function(t, e, n, i) {
                this.axisPointerClass && Lh(t), $w.superApply(this, "render", arguments), Rh(this, t, 0, n, 0, !0)
            },
            ...
            dispose: function(t, e) {
                Bh(this, e), $w.superApply(this, "dispose", arguments)
            }
        }),
        Kw = [];
    ...
    var Qw = ["axisLine", "axisTickLabel", "axisName"],
        Jw = ["splitArea", "splitLine"],
        tb = $w.extend({
            type: "cartesianAxis",
            ...
            render: function(t, e, n, i) {
                ...
                if (this._axisGroup = new Sg, this.group.add(this._axisGroup), t.get("show")) {
                    var o = t.getCoordSysModel(),
                        a = Vh(o, t),
                        s = new Uw(t, a);
                    d(Qw, s.add, s), this._axisGroup.add(s.getGroup()), d(Jw, function(e) {
                        t.get(e + ".show") && this["_" + e](t, o)
                    }, this), cr(r, this._axisGroup, t), tb.superCall(this, "render", t, e, n, i)
                }
            },
            remove: function() {
            ...
            _splitLine: function(t, e) {
                ...
                if (!n.scale.isBlank()) {
                    ...
                    for (var s = e.coordinateSystem.getRect(), l = n.isHorizontal(), h = 0, u = n.getTicksCoords({
                        ...
                        var m = h++ % o.length;
                        this._axisGroup.add(new Fv(zi({
                            anid: "line_" + u[p].tickValue,
                            shape: {
                                x1: c[0],
                                y1: c[1],
                                x2: d[0],
    ...
    }), ns(kw("line", "circle", "line")), es(Pw("line")), Ja(Ux.PROCESSOR.STATISTIC, function(t) {
        return {
            seriesType: t,
            modifyOutputEnd: !0,
            reset: function(t, e, n) {
                ...
                if ("cartesian2d" === o.type && r) {
                    ...
                    if (u > 1) {
                        var c;
                        "string" == typeof r ? c = Lw[r] : "function" == typeof r && (c = r), c && t.setData(i.downSample(i.mapDimension(s.dim), 1 / u, c, Ow))
                    }
                }
            }
        }
    ...
    o(pr.prototype, nb), ls({
            ...
            o.diff(a).add(function(e) {
                if (o.hasValue(e)) {
                    var n = o.getItemModel(e),
                        a = ob[s.type](o, e, n),
                        l = rb[s.type](o, e, n, a, i, h);
                    o.setItemGraphicEl(e, l), r.add(l), Zh(l, o, e, n, a, t, i, "polar" === s.type)
                }
            }).update(function(e, n) {
                ...
                if (o.hasValue(e)) {
                    ...
                    l ? ar(l, {
                        shape: c
                    }, h, e) : l = rb[s.type](o, e, u, c, i, h, !0), o.setItemGraphicEl(e, l), r.add(l), Zh(l, o, e, u, c, t, i, "polar" === s.type)
                } else r.remove(l)
            }).remove(function(t) {
                var e = a.getItemGraphicEl(t);
                "cartesian2d" === s.type ? e && Gh(t, h, e) : e && Wh(t, h, e)
            }).execute(), this._data = o
        },
        _renderLarge: function(t, e, n) {
            this._clear(), Xh(t, this.group)
        },
        ...
        _clear: function(t) {
            ...
            t && t.get("animation") && n && !this._isLargeDraw ? n.eachItemGraphicEl(function(e) {
                "sector" === e.type ? Wh(e.dataIndex, t, e) : Gh(e.dataIndex, t, e)
            ...
            cartesian2d: function(t, e, n, i, r, a, s) {
                ...
                if (a) {
                    var h = l.shape,
                        u = r ? "height" : "width",
                        c = {};
                    h[u] = 0, c[u] = i[u], Jv[s ? "updateProps" : "initProps"](l, {
                        shape: c
                    }, a, e)
                }
                return l
            ...
            polar: function(t, e, n, i, r, o, s) {
                ...
                if (o) {
                    var u = h.shape,
                        c = r ? "r" : "endAngle",
                        d = {};
                    u[c] = r ? 0 : i.startAngle, d[c] = i[c], Jv[s ? "updateProps" : "initProps"](h, {
                        shape: d
                    }, o, e)
                }
                return h
    ...
    es(v(function(t, e) {
        ...
        d(n, function(t) {
            ...
            for (var d = e.mapDimension(u.dim), f = e.mapDimension(o.dim), p = Ps(e, d, f), g = u.isHorizontal(), m = Qs(o, u, p), v = 0, y = e.count(); v < y; v++) {
                var x = e.get(d, v),
                    _ = e.get(f, v);
                if (!isNaN(x)) {
                    var w = x >= 0 ? "p" : "n",
                    ...
                    var S, M, I, C;
                    if (g) S = b, M = (T = n.dataToPoint([x, _]))[1] + l, I = T[0] - m, C = h, Math.abs(I) < c && (I = (I < 0 ? -1 : 1) * c), p && (r[a][_][w] += I);
                    else {
                        var T = n.dataToPoint([_, x]);
                        S = T[0] + l, M = b, I = h, C = T[1] - m, Math.abs(C) < c && (C = (C <= 0 ? -1 : 1) * c), p && (r[a][_][w] += C)
                    }
                    e.setItemLayout(v, {
                        x: S,
                        y: M,
    ...
    ub.updateData = function(t, e, n) {
        ...
        f && s.attr("cursor", f), qh(this, t.getItemLayout(e), l.isSelected(null, e), l.get("selectedOffset"), l.get("animation")), s.off("mouseover").off("mouseout").off("emphasis").off("normal"), h.get("hoverAnimation") && l.isAnimationEnabled() && s.on("mouseover", i).on("mouseout", r).on("emphasis", i).on("normal", r), this._updateLabel(t, e), qi(this)
    }, ub._updateLabel = function(t, e) {
    ...
    var cb = function(t, e, n, i) {
            ...
            }), !l && t.get("avoidLabelOverlap") && Qh(s, r, o, e, n, i)
        },
        db = 2 * Math.PI,
        fb = Math.PI / 180;
    ! function(t, e) {
    ...
    gb.isPersistent = function() {
        ...
        t.setShape("size", r instanceof Array ? r : [r, r]), t.symbolProxy = ul(e.getVisual("symbol"), 0, 0, 0, 0), t.setColor = t.symbolProxy.setColor;
        ...
        _updateSymbolDraw: function(t, e) {
            ...
            return n && i === this._isLargeDraw || (n && n.remove(), n = this._symbolDraw = i ? new Jh : new Nl, this._isLargeDraw = i, this.group.removeAll()), this.group.add(n.group), n
        },
        remove: function(t, e) {
            this._symbolDraw && this._symbolDraw.remove(!0), this._symbolDraw = null
        },
        dispose: function() {}
    }), ns(kw("scatter", "circle")), es(Pw("scatter")), Qa(function(t) {
        var e = t.graphic;
    ...
    var mb = os({
        ...
        optionUpdated: function(t, e) {
            ...
            d(a, function(t, e) {
                var n = t.option;
                n && (s.push(n), ru(t, n), ou(r, e, n), au(r[e], n))
            }, this);
        ...
        _updateElements: function(t, e) {
            ...
            if (n) {
                ...
                d(n, function(t) {
                    ...
                    var h = nu(t);
                    e && "merge" !== e ? "replace" === e ? (eu(o, i), tu(n, s, h, i)) : "remove" === e && eu(o, i) : o ? o.attr(h) : tu(n, s, h, i);
                    var u = i.get(n);
    ...
    var vb = function(t, e) {
        ...
        Sb = as({
            ...
            render: function(t, e, n) {
                ...
                vu("axisPointer", n, function(t, e, n) {
            ...
            remove: function(t, e) {
                Su(e.getZr(), "axisPointer"), Sb.superApply(this._model, "remove", arguments)
            },
            dispose: function(t, e) {
                Su("axisPointer", e), Sb.superApply(this._model, "dispose", arguments)
            }
        }),
        Mb = Dn(),
        Ib = n,
    ...
    (Mu.prototype = {
        ...
        _renderHandle: function(t) {
            if (!this._dragging && this.updateHandleTransform) {
                ...
                var l = r.get("size");
                y(l) || (l = [l, l]), i.attr("scale", [l[0] / 2, l[1] / 2]), ua(this, "_doDispatchAxisPointer", r.get("throttle") || 0, "fixRate"), this._moveHandleToValue(t, a)
            }
        },
        _moveHandleToValue: function(t, e) {
            Iu(this._axisPointerModel, !e && this._moveAnimation, this._handle, Du(this.getHandleTransform(t, this._axisModel, this._axisPointerModel)))
        },
        _onHandleDragMove: function(t, e) {
            var n = this._handle;
            if (n) {
                this._dragging = !0;
                var i = this.updateHandleTransform(Du(n), [t, e], this._axisModel, this._axisPointerModel);
                this._payloadInfo = i, n.stopAnimation(), n.attr(Du(i)), Mb(n).lastProp = null, this._doDispatchAxisPointer()
            }
        },
    ...
    }).constructor = Mu, En(Mu);
    var Tb = Mu.extend({
            makeElOption: function(t, e, n, i, r) {
                var o = n.axis,
                    a = o.grid,
                    s = i.get("type"),
                    l = Bu(a, o).getOtherAxis(o).getGlobalExtent(),
                ...
                Eu(e, t, Vh(a.model, n), n, i, r)
            },
            getHandleTransform: function(t, e, n) {
                var i = Vh(e.axis.grid.model, e, {
                    labelInside: !1
                });
                return i.labelMargin = n.get("handle.margin"), {
                    position: zu(e.axis, t, i),
            ...
            updateHandleTransform: function(t, e, n, i) {
                var r = n.axis,
                    ...
                    s = Bu(o, r).getOtherAxis(r).getGlobalExtent(),
                    l = "x" === r.dim ? 0 : 1,
                    h = t.position;
        ...
        Db = {
            ...
            shadow: function(t, e, n, i) {
                ...
                return {
                    type: "Rect",
                    shape: Ru([e - r / 2, n[0]], [r, o], Vu(t))
                }
            }
        };
    $w.registerAxisPointerClass("CartesianAxisPointer", Tb), Qa(function(t) {
        if (t) {
            (!t.axisPointer || 0 === t.axisPointer.length) && (t.axisPointer = {});
            var e = t.axisPointer.link;
            e && !y(e) && (t.axisPointer.link = [e])
        }
    }), Ja(Ux.PROCESSOR.STATISTIC, function(t, e) {
        t.getComponent("axisPointer").coordSysAxesInfo = Ch(t, e)
    }), ts({
        type: "updateAxisPointer",
        ...
        if (s) {
            ...
            yb(s.coordSysMap, function(t, e) {
                ...
                yb(s.coordSysAxesInfo[e], function(t, e) {
                    ...
                    if (!c && n && (!h || o)) {
                        var a = o && o.value;
                        null != a || l || (a = i.pointToData(r)), null != a && su(t, a, g, !1, d)
                    }
                })
            });
            var v = {};
            return yb(u, function(t, e) {
                var n = t.linkGroup;
                n && !f[e] && yb(n.axesInfo, function(e, i) {
                    var r = f[i];
                    if (e !== t && r) {
                        var o = r.value;
                        n.mapper && (o = t.axis.scale.parse(n.mapper(o, gu(e), gu(t)))), v[t.key] = o
                    }
                })
            }), yb(v, function(t, e) {
                su(u[e], t, g, !0, d)
            }), cu(f, u, d), du(p, r, t, a), fu(u, 0, n), d
        }
    }), os({
        type: "tooltip",
    ...
    Wu.prototype = {
        ...
        show: function(t) {
            ...
            var e = this.el;
            e.style.cssText = "position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;" + Gu(t) + ";left:" + this._x + "px;top:" + this._y + "px;" + (t.get("extraCssText") || ""), e.style.display = e.innerHTML ? "block" : "none", this._show = !0
        },
    ...
    as({
        ...
        _initGlobalListener: function() {
            ...
            vu("itemTooltip", this._api, Lb(function(e, n, i) {
        ...
        manuallyHideTip: function(t, e, n, i) {
            ...
            !this._alwaysShowContent && this._tooltipModel && r.hideLater(this._tooltipModel.get("hideDelay")), this._lastX = this._lastY = null, i.from !== this.uid && this._hide(Uu(i, n))
        },
        _manuallyAxisShowTip: function(t, e, n, i) {
            ...
            if (null != r && null != o && null != a) {
                ...
                if (s && "axis" === (t = Zu([s.getData().getItemModel(o), s, (s.coordinateSystem || {}).model, t])).get("trigger")) return n.dispatchAction({
                    type: "updateAxisPointer",
                    seriesIndex: r,
                    dataIndex: o,
                    position: i.position
            ...
            Ob(t, function(t) {
                Ob(t.dataByAxis, function(t) {
                    var e = n.getComponent(t.axisDim + "Axis", t.axisIndex),
                        ...
                        r = [];
                    if (e && null != i) {
                        var s = Ou(i, e.axis, n, t.seriesDataIndices, t.valueLabelOpt);
                        d(t.seriesDataIndices, function(o) {
                            var l = n.getSeriesByIndex(o.seriesIndex),
                                h = o.dataIndexInside,
                                u = l && l.getDataParams(h);
                            u.axisDim = t.axisDim, u.axisIndex = t.axisIndex, u.axisType = t.axisType, u.axisId = t.axisId, u.axisValue = al(e.axis, i), u.axisValueLabel = s, u && (a.push(u), r.push(l.formatTooltip(h, !0)))
                        });
                        var l = s;
        ...
        _showSeriesItemTooltip: function(t, e, n) {
            var i = this._ecModel,
                ...
                l = e.dataType,
                h = a.getData(),
                u = Zu([h.getItemModel(s), a, o && (o.coordinateSystem || {}).model, this._tooltipModel]),
                c = u.get("trigger");
            if (null == c || "item" === c) {
        ...
        _updatePosition: function(t, e, n, i, r, o, a) {
            ...
            } else "string" == typeof e && a ? (n = (p = qu(e, d, h))[0], i = p[1]) : (n = (p = Xu(n, i, r.el, s, l, u ? null : 20, c ? null : 20))[0], i = p[1]);
            if (u && (n -= $u(u) ? h[0] / 2 : "right" === u ? h[0] : 0), c && (i -= $u(c) ? h[1] / 2 : "bottom" === c ? h[1] : 0), t.get("confine")) {
                var p = ju(n, i, r.el, s, l);
                n = p[0], i = p[1]
            }
            r.moveTo(n, i)
        },
        ...
        dispose: function(t, e) {
            wp.node || wp.wxa || (this._tooltipContent.hide(), Su("itemTooltip", e))
        }
    }), ts({
        type: "showTip",
        event: "showTip",
    ...
    ts("legendToggleSelect", "legendselectchanged", v(Ku, "toggleSelected")), ts("legendSelect", "legendselected", v(Ku, "select")), ts("legendUnSelect", "legendunselected", v(Ku, "unSelect"));
    var Rb = v,
        Bb = d,
        Vb = Sg,
        Fb = as({
            ...
            render: function(t, e, n) {
                if (this.resetInner(), t.get("show", !0)) {
                    ...
                    this.group.attr("position", [u.x - h.x, u.y - h.y]), this.group.add(this._backgroundEl = Ju(h, t))
                }
            },
            resetInner: function() {
                    ...
                    if (this.newlineDisabled || "" !== u && "\n" !== u) {
                        ...
                        if (!o.get(u))
                            if (c) {
                                ...
                                this._createItem(u, h, l, e, p, g, t, f, a).on("click", Rb(tc, u, i)).on("mouseover", Rb(ec, c, null, i, s)).on("mouseout", Rb(nc, c, null, i, s)), o.set(u, !0)
                                ...
                                if (!o.get(u) && n.legendDataProvider) {
                                    ...
                                    this._createItem(u, h, l, e, "roundRect", null, t, d, a).on("click", Rb(tc, u, i)).on("mouseover", Rb(ec, n, u, i, s)).on("mouseout", Rb(nc, n, u, i, s)), o.set(u, !0)
                                }
                            }, this)
                    } else r.add(new Vb({
                        newline: !0
            ...
            _createItem: function(t, e, n, i, r, a, s, l, h) {
                var u = i.get("itemWidth"),
                    ...
                    x = y.parentModel;
                if (r = v || r, g.add(ul(r, 0, 0, u, c, p ? l : d, null == f || f)), !v && a && (a !== r || "none" == a)) {
                    var _ = .8 * c;
                    "none" === a && (a = "circle"), g.add(ul(a, (u - _) / 2, (c - _) / 2, _, _, p ? l : d, null == f || f))
                }
                var w = "left" === s ? u + 5 : -5,
                    b = s,
                    S = i.get("formatter"),
                    M = t;
                "string" == typeof S && S ? M = S.replace("{name}", null != t ? t : "") : "function" == typeof S && (M = S(t)), g.add(new Av({
                    style: Ki({}, m, {
                        text: M,
                        x: w,
                        y: c / 2,
                ...
                return g.add(I), g.eachChild(function(t) {
                    t.silent = !0
                }), I.silent = !h, this.getContentGroup().add(g), qi(g), g.__legendDataIndex = e, g
            },
    ...
    var Hb = Nb.extend({
            ...
            init: function(t, e, n, i) {
                var r = Ur(t);
                Hb.superCall(this, "init", t, e, n, i), ic(this, t, r)
            },
            mergeOption: function(t, e) {
                Hb.superCall(this, "mergeOption", t, e), ic(this, this.option, t)
            },
            getOrient: function() {
        ...
        Ub = Fb.extend({
            ...
            newlineDisabled: !0,
            init: function() {
                Ub.superCall(this, "init"), this._currentIndex = 0, this.group.add(this._containerGroup = new Gb), this._containerGroup.add(this.getContentGroup()), this.group.add(this._controllerGroup = new Gb), this._showController
            },
            resetInner: function() {
                Ub.superCall(this, "resetInner"), this._controllerGroup.removeAll(), this._containerGroup.removeClipPath(), this._containerGroup.__rectSize = null
            },
            renderInner: function(t, e, n, i) {
                function r(t, n) {
                    var r = t + "DataIndex",
            ...
            layoutInner: function(t, e, n) {
                var i = this.getContentGroup(),
                    ...
                    l = Wb[1 - a],
                    h = Zb[1 - a];
                wy(t.get("orient"), i, t.get("itemGap"), a ? n.width : null, a ? null : n.height), wy("horizontal", o, t.get("pageButtonItemGap", !0));
        ...
        Yb = os({
            ...
            mergeOption: function(t, e, n, i) {
                ...
                n || e.eachSeries(function(t) {
                    var n = t.get(this.mainType, !0),
                        s = t[a];
                    n && n.data ? (s ? s.mergeOption(n, e, !0) : (i && rc(n), d(n.data, function(t) {
                        t instanceof Array ? (rc(t[0]), rc(t[1])) : rc(t)
                    }), o(s = new r(n, this, e), {
            ...
            formatTooltip: function(t) {
                var e = this.getData(),
                    ...
                    i = y(n) ? f(n, Xb).join(", ") : Xb(n),
                    r = e.getName(t),
                    o = jb(this.name);
                return (null != n || r) && (o += "<br />"), r && (o += jb(r), null != n && (o += " : ")), null != n && (o += jb(i)), o
            },
            getData: function() {
                return this._data
            },
    ...
    Qb.extend({
        ...
        updateTransform: function(t, e, n) {
            e.eachSeries(function(t) {
                ...
                e && (pc(e.getData(), t, n), this.markerGroupMap.get(t.id).updateLayout(e))
            }, this)
        },
        renderSeries: function(t, e, n, i) {
            var r = t.coordinateSystem,
                ...
                l = s.get(o) || s.set(o, new Nl),
                h = gc(r, t, e);
            e.setData(h), pc(e.getData(), t, i), h.each(function(t) {
    ...
    var Jb = Fv.prototype,
        ...
        eS = Ai({
            ...
            buildPath: function(t, e) {
                (mc(e) ? Jb : tS).buildPath(t, e)
            },
            pointAt: function(t) {
                return mc(this.shape) ? Jb.pointAt.call(this, t) : tS.pointAt.call(this, t)
            },
            tangentAt: function(t) {
                var e = this.shape,
                    n = mc(e) ? [e.x2 - e.x1, e.y2 - e.y1] : tS.tangentAt.call(this, t);
                return j(n, n)
            }
        }),
    ...
    iS.beforeUpdate = function() {
        ...
        this.add(o), d(nS, function(n) {
            var i = yc(n, t, e);
            this.add(i), this[vc(n)] = t.getItemVisual(e, n)
        ...
        _c(a.shape, o), ar(r, a, i, e), d(nS, function(n) {
        ...
        r.useStyle(a({
            ...
            stroke: c,
            opacity: f
        }, o)), r.hoverStyle = s, d(nS, function(t) {
    ...
    rS.isPersistent = function() {
        ...
        this._seriesScope = Ic(t), this._lineData = null, this.group.removeAll()
    ...
    var oS = function(t, e, r, a) {
        var s = t.getData(),
            l = a.type;
        if (!y(a) && ("min" === l || "max" === l || "average" === l || "median" === l || null != a.xAxis || null != a.yAxis)) {
            var h, u;
            if (null != a.yAxis || null != a.xAxis) h = null != a.yAxis ? "y" : "x", e.getAxis(h), u = C(a.yAxis, a.xAxis);
            else {
                var c = hc(a, s, e, t);
                h = c.valueDataDim, c.valueAxis, u = fc(s, h, l)
            }
            var d = "x" === h ? 0 : 1,
                f = 1 - d,
                p = n(a),
        ...
        return a = [lc(t, a[0]), lc(t, a[1]), o({}, a[2])], a[2].type = a[2].type || "", i(a[2], a[0]), i(a[2], a[1]), a
    };
    Qb.extend({
        type: "markLine",
        updateTransform: function(t, e, n) {
        ...
        renderSeries: function(t, e, n, i) {
            function r(e, n, r) {
                var o = e.getItemModel(n);
                Pc(e, n, r, t, i), e.setItemVisual(n, {
    ...
    Qb.extend({
        ...
        renderSeries: function(t, e, n, i) {
            ...
            e.setData(u), u.each(function(e) {
                u.setItemLayout(e, f(sS, function(n) {
                    return Nc(u, e, n, t, i)
                })), u.setItemVisual(e, {
    ...
    var lS = ["cartesian2d", "polar", "singleAxis"],
        hS = function(t, e) {
    ...
    dS.prototype = {
        ...
        calculateDataWindow: function(t) {
            var e = this._dataExtent,
                ...
                o = [t.start, t.end],
                a = [];
            return uS(["startValue", "endValue"], function(e) {
        ...
        reset: function(t) {
            if (t === this._dataZoomModel) {
                ...
                this._dataExtent = Fc(this, this._dimName, e);
                var n = this.calculateDataWindow(t.option);
                this._valueWindow = n.valueWindow, this._percentWindow = n.percentWindow, Wc(this), Gc(this)
            }
        },
        restore: function(t) {
            t === this._dataZoomModel && (this._valueWindow = this._percentWindow = null, Gc(this, !0))
        },
    ...
    var fS = d,
        ...
        gS = os({
            ...
            doInit: function(t) {
                var e = this.option;
                wp.canvasSupported || (e.realtime = !1), this._setDefaultThrottle(t), Uc(this, t), fS([
                    ["start", "startValue"],
                    ["end", "endValue"]
                ], function(t, n) {
            ...
            _giveAxisProxies: function() {
                ...
                this.eachTargetAxis(function(e, n, i, r) {
                    var o = this.dependentModels[e.axis][n],
                        a = o.__dzAxisProxy || (o.__dzAxisProxy = new dS(e.name, n, this, r));
                    t[e.name + "_" + n] = a
                }, this)
            },
        ...
        vS = (gS.extend({
            ...
            e[0] = jc(e[0], n), e[1] = jc(e[1], n), t = t || 0;
            var a = n[1] - n[0];
            null != r && (r = jc(r, [0, a])), null != o && (o = Math.max(o, null != r ? r : 0)), "all" === i && (r = o = Math.abs(e[1] - e[0]), i = 0);
            var s = Xc(e, i);
            e[i] += t;
            var l = r || 0,
                h = n.slice();
            s.sign < 0 ? h[0] += l : h[1] -= l, e[i] = jc(e[i], h);
            u = Xc(e, i);
        ...
        SS = "horizontal",
        MS = 5,
        IS = ["line", "bar", "candlestick", "scatter"],
        CS = mS.extend({
            type: "dataZoom.slider",
            init: function(t, e) {
            ...
            render: function(t, e, n, i) {
                CS.superApply(this, "render", arguments), ua(this, "_dispatchZoomAction", this.dataZoomModel.get("throttle"), "fixRate"), this._orient = t.get("orient"), !1 !== this.dataZoomModel.get("show") ? (i && "dataZoom" === i.type && i.from === this.uid || this._buildView(), this._updateView()) : this.group.removeAll()
            },
            remove: function() {
                CS.superApply(this, "remove", arguments), ca(this, "_dispatchZoomAction")
            },
            dispose: function() {
                CS.superApply(this, "dispose", arguments), ca(this, "_dispatchZoomAction")
            },
            _buildView: function() {
                var t = this.group;
            ...
            _updateInterval: function(t, e) {
                ...
                var s = this._range,
                    l = this._range = _S([xS(i[0], r, a, !0), xS(i[1], r, a, !0)]);
    ...
    var DS = v,
        ...
        PS = mS.extend({
            ...
            render: function(t, e, n, i) {
                PS.superApply(this, "render", arguments), this._range = t.getPercentRange(), d(this.getTargetCoordInfo(), function(e, i) {
            ...
            dispose: function() {
                hd(this.api, this.dataZoomModel.id), PS.superApply(this, "dispose", arguments), this._range = null
            },
            _onPan: function(t, e, n, i, r, o, a, s, l) {
                var h = this._range,
                    ...
                    c = t.axisModels[0];
                if (c) {
                    var d = LS[e]([o, a], [s, l], c, n, t),
                        f = d.signal * (u[1] - u[0]) * d.pixel / d.pixelLength;
                    return vS(f, u, [0, 100], "all"), this._range = u, h[0] !== u[0] || h[1] !== u[1] ? u : void 0
                }
            },
            _onZoom: function(t, e, n, i, r, o) {
                var a = this._range,
                    ...
                    l = t.axisModels[0];
                if (l) {
                    var h = LS[e](null, [r, o], l, n, t),
                        u = (h.signal > 0 ? h.pixelStart + h.pixelLength - h.pixel : h.pixel - h.pixelStart) / h.pixelLength * (s[1] - s[0]) + s[0];
                    i = Math.max(1 / i, 0), s[0] = (s[0] - u) * i + u, s[1] = (s[1] - u) * i + u;
    ...
    Ja({
        ...
        var n = Vc(m(e.eachComponent, e, "dataZoom"), hS, function(t, e) {
    ...
    var OS = {},
        zS = os({
            ...
            optionUpdated: function() {
                zS.superApply(this, "optionUpdated", arguments), d(this.option.feature, function(t, e) {
                    var n = _d(e);
    ...
    as({
        ...
        render: function(t, e, n, i) {
            ...
            if (a.removeAll(), t.get("show")) {
                ...
                d(l, function(t, e) {
                    u.push(e)
                }), new us(this._featureNames || [], u).add(r).update(r).remove(v(r, null)).execute(), this._featureNames = u, Qu(a, t, n), a.add(Ju(a.getBoundingRect(), t)), a.eachChild(function(t) {
                    var e = t.__title,
                        i = t.hoverStyle;
                    if (i && e) {
                        var r = ce(e, Ce(i)),
    ...
    bd.defaultOption = {
        ...
        pixelRatio: 1,
        lang: ES.lang.slice()
    }, bd.prototype.unusable = !wp.canvasSupported, bd.prototype.onclick = function(t, e) {
        var n = this.model,
        ...
        if (r.href = a, "function" != typeof MouseEvent || wp.browser.ie || wp.browser.edge)
    ...
    var FS = Sx.toolbox.dataView,
        HS = new Array(60).join("-"),
        GS = "\t",
        WS = new RegExp("[" + GS + "]+", "g");
    Od.defaultOption = {
        show: !0,
        ...
        buttonColor: "#c23531",
        buttonTextColor: "#fff"
    }, Od.prototype.onclick = function(t, e) {
        function n() {
        ...
        on(v, "click", n), on(y, "click", function() {
            ...
            if (9 === (t.keyCode || t.which)) {
                var e = this.value,
                    ...
                    i = this.selectionEnd;
                this.value = e.substring(0, n) + GS + e.substring(i), this.selectionStart = this.selectionEnd = n + 1, Jg(t)
            }
        }), o.appendChild(a), o.appendChild(l), o.appendChild(g), l.style.height = i.clientHeight - 80 + "px", i.appendChild(o), this._dom = o
    }, Od.prototype.remove = function(t, e) {
        this._dom && e.getDom().removeChild(this._dom)
    }, Od.prototype.dispose = function(t, e) {
        this.remove(t, e)
    }, xd("dataView", Od), ts({
        type: "changeDataView",
    ...
    Ed.prototype = {
        ...
        enableBrush: function(t) {
            return this._brushType && Rd(this), t.brushType && Nd(this, t), this
        },
        ...
        updateCovers: function(t) {
            ...
            function r(e, n) {
                ...
                if (null != n && a[n] === h) s[e] = a[n];
                    ...
                    var r = s[e] = null != n ? (a[n].__brushOption = i, a[n]) : Vd(l, Bd(l, i));
                    Gd(l, r)
                }
            }
            t = f(t, function(t) {
            ...
            return new us(a, t, function(t, n) {
        ...
        unmount: function() {
            return this.enableBrush(!1), Xd(this), this._zr.remove(this.group), this
        },
        dispose: function() {
    ...
    var rM = {
            mousedown: function(t) {
                if (this._dragging) gf.call(this, t);
                else if (!t.target || !t.target.draggable) {
                    cf(t);
                    var e = this.group.transformCoordToLocal(t.offsetX, t.offsetY);
                    this._creatingCover = null, (this._creatingPanel = Zd(this, t, e)) && (this._dragging = !0, this._track = [e.slice()])
                }
            },
            mousemove: function(t) {
                var e = this.group.transformCoordToLocal(t.offsetX, t.offsetY);
                if (uf(this, t, e), this._dragging) {
                    cf(t);
                    var n = ff(this, t, e, !1);
                    n && jd(this, n)
                }
        ...
        oM = {
            ...
            rect: {
                ...
                getCreatingRange: function(t) {
                    var e = qd(t);
                    return ef(e[1][0], e[1][1], e[0][0], e[0][1])
                },
        ...
        lM = l,
        hM = v,
        uM = ["dataToPoint", "pointToData"],
        cM = ["grid", "xAxis", "yAxis", "geo", "graph", "polar", "radiusAxis", "angleAxis", "bmap"],
        dM = bf.prototype;
    dM.setOutputRanges = function(t, e) {
        ...
        sM(t, function(t) {
            ...
            if (t.range = t.range || [], n && !0 !== n) {
                t.panelId = n.panelId;
                var i = mM[t.brushType](0, n.coordSys, t.coordRange),
                    r = t.__rangeOffset;
                t.range = r ? vM[t.brushType](i.values, r.offset, Tf(i.xyMinMax, r.xyMinMax)) : i.values
            }
        }, this)
        ...
        return f(this._targetInfoList, function(n) {
            ...
            return {
                ...
                clipPath: yf(i),
                isTargetByCursor: _f(i, t, n.coordSysModel),
                getLinearBrushOtherExtent: xf(i)
            }
        })
        ...
        for (var n = this._targetInfoList, i = Mf(e, t), r = 0; r < n.length; r++) {
            var o = n[r],
                a = t.panelId;
            if (a) {
                if (o.panelId === a) return o
            } else
                for (r = 0; r < pM.length; r++)
                    if (pM[r](i, o)) return o
        }
        return !0
    };
    var fM = {
        ...
        mM = {
            ...
            lineY: hM(If, 1),
            rect: function(t, e, n) {
                var i = e[uM[t]]([n[0][0], n[1][0]]),
                    r = e[uM[t]]([n[0][1], n[1][1]]),
    ...
    var _M = Sx.toolbox.dataZoom,
        wM = d,
        bM = "\0_ec_\0toolbox-dataZoom_";
    zf.defaultOption = {
        show: !0,
        icon: {
    ...
    SM.render = function(t, e, n, i) {
        this.model = t, this.ecModel = e, this.api = n, Rf(t, e, this, i, n), Nf(t, e)
    ...
    var MM = {
        ...
        back: function() {
            this._dispatchZoomAction(kf(this.ecModel))
        }
    };
    SM._onBrush = function(t, e) {
        function n(t, e, n) {
            ...
            null == h.minValueSpan && null == h.maxValueSpan || (n = vS(0, n.slice(), a.scale.getExtent(), 0, h.minValueSpan, h.maxValueSpan)), l && (r[l.id] = {
                dataZoomId: l.id,
                startValue: n[0],
                endValue: n[1]
            })
        ...
        if (e.isEnd && t.length) {
            var r = {},
                o = this.ecModel;
            this._brushController.updateCovers([]), new bf(Ef(this.model.option), o, {
                include: ["grid"]
            ...
            }), Af(o, r), this._dispatchZoomAction(r)
        }
    ...
    Bf.defaultOption = {
        ...
        title: IM.title
    }, Bf.prototype.onclick = function(t, e, n) {
        Pf(t), e.dispatchAction({
            type: "restore",
            from: this.uid
        })
    }, xd("restore", Bf), ts({
    ...
    var CM, TM = "urn:schemas-microsoft-com:vml",
        DM = "undefined" == typeof window ? null : window,
        AM = !1,
        kM = DM && DM.document;
    if (kM && !wp.canvasSupported) try {
    ...
    if (!wp.canvasSupported) {
        var BM = 21600,
            VM = BM / 2,
            FM = function(t) {
                t.style.cssText = "position:absolute;left:0;top:0;width:1px;height:1px;", t.coordsize = BM + "," + BM, t.coordorigin = "0,0"
            },
            HM = function(t) {
                    ...
                    if (i instanceof Uv) {
                        ...
                        if ("linear" === i.type) {
                            ...
                            var f = [i.x * u, i.y * c],
                                ...
                                y = u,
                                x = c;
                            a = [(f[0] - h.x) / y, (f[1] - h.y) / x], d && $(f, f, d), y /= v[0] * BM, x /= v[1] * BM;
                            var _ = RM(y, x);
                            s = 0 / _, l = 2 * i.r / _ - s
                        }
            ...
            KM = function(t, e, n, i) {
                ...
                null != n[e] && "none" !== n[e] && (r || !r && n.lineWidth) ? (t[r ? "filled" : "stroked"] = "true", n[e] instanceof Uv && ZM(t, o), o || (o = Vf(e)), r ? qM(o, n, i) : $M(o, n), WM(t, o)) : (t[r ? "filled" : "stroked"] = "false", ZM(t, o))
            },
            QM = [
                [],
                [],
            ...
            JM = function(t, e) {
                ...
                for (o = 0; o < g;) {
                    switch (r = p[o++], i = "", n = 0, r) {
                        ...
                        case h:
                            ...
                            var m, v, y = p[o++],
                                ...
                                _ = p[o++],
                                w = p[o++];
                            r === d ? (m = _, v = w, _ = (_ + 2 * y) / 3, w = (w + 2 * x) / 3, y = (a + 2 * y) / 3, x = (s + 2 * x) / 3) : (m = p[o++], v = p[o++]), QM[0][0] = y, QM[0][1] = x, QM[1][0] = _, QM[1][1] = w, QM[2][0] = m, QM[2][1] = v, a = m, s = v;
                            break;
                        case c:
                            var b = 0,
                                S = 0,
                                ...
                                I = 1,
                                C = 0;
                            e && (b = e[4], S = e[5], M = OM(e[0] * e[0] + e[1] * e[1]), I = OM(e[2] * e[2] + e[3] * e[3]), C = Math.atan2(-e[1] / I, e[0] / M));
                            var T = p[o++],
                                D = p[o++],
                                A = p[o++],
                                k = p[o++],
                            ...
                            var O = p[o++],
                                ...
                                x = D + NM(L) * k,
                                N = O ? " wa " : " at ";
                            Math.abs(z - y) < 1e-4 && (Math.abs(L - P) > .01 ? O && (z += .0125) : Math.abs(E - D) < 1e-4 ? O && z < T || !O && z > T ? x -= .0125 : x += .0125 : O && E < D || !O && E > D ? y += .0125 : y -= .0125), f.push(N, LM(((T - A) * M + b) * BM - VM), ",", LM(((D - k) * I + S) * BM - VM), ",", LM(((T + A) * M + b) * BM - VM), ",", LM(((D + k) * I + S) * BM - VM), ",", LM((z * M + b) * BM - VM), ",", LM((E * I + S) * BM - VM), ",", LM((y * M + b) * BM - VM), ",", LM((x * I + S) * BM - VM)), a = y, s = x;
                            break;
                        case PM.R:
                            var R = QM[0],
                                B = QM[1];
                            R[0] = p[o++], R[1] = p[o++], B[0] = R[0] + p[o++], B[1] = R[1] + p[o++], e && ($(R, R, e), $(B, B, e)), R[0] = LM(R[0] * BM - VM), B[0] = LM(B[0] * BM - VM), R[1] = LM(R[1] * BM - VM), B[1] = LM(B[1] * BM - VM), f.push(" m ", R[0], ",", R[1], " l ", B[0], ",", R[1], " l ", B[0], ",", B[1], " l ", R[0], ",", B[1]);
                            break;
                        case PM.Z:
                            f.push(" x ")
                    }
                    if (n > 0) {
                        ...
                        for (var V = 0; V < n; V++) {
                            var F = QM[V];
                            e && $(F, F, e), f.push(LM(F[0] * BM - VM), ",", LM(F[1] * BM - VM), V < n - 1 ? "," : "")
                        }
                    }
                }
                return f.join("")
        ...
        xi.prototype.brushVML = function(t) {
            var e = this.style,
                n = this._vmlEl;
            n || (n = Vf("shape"), FM(n), this._vmlEl = n), KM(n, "fill", e, this), KM(n, "stroke", e, this);
            ...
            this.__dirtyPath && (l.beginPath(), this.buildPath(l, this.shape), l.toStatic(), this.__dirtyPath = !1), n.path = JM(l, this.transform), n.style.zIndex = UM(this.zlevel, this.z, this.z2), WM(t, n), null != e.text ? this.drawRectText(t, this.getBoundingRect()) : this.removeRectText(t)
        ...
        je.prototype.brushVML = function(t) {
            ...
            if (r) {
                ...
                var x, _ = y.style,
                    ...
                    b = 1,
                    S = 1;
                if (this.transform && (x = this.transform, b = OM(x[0] * x[0] + x[1] * x[1]), S = OM(x[2] * x[2] + x[3] * x[3]), w = x[1] || x[2]), w) {
                    var M = [h, u],
                        I = [h + c, u],
                        C = [h, u + d],
                        T = [h + c, u + d];
                    $(M, M, x), $(I, I, x), $(C, C, x), $(T, T, x);
                    var D = RM(M[0], I[0], C[0], T[0]),
                        A = RM(M[1], I[1], C[1], T[1]),
                        k = [];
                    k.push("M11=", x[0] / b, ",", "M12=", x[2] / S, ",", "M21=", x[1] / b, ",", "M22=", x[3] / S, ",", "Dx=", LM(h * b + x[4]), ",", "Dy=", LM(u * S + x[5])), _.padding = "0 " + LM(D) + "px " + LM(A) + "px 0", _.filter = "progid:DXImageTransform.Microsoft.Matrix(" + k.join("") + ", SizingMethod=clip)"
                } else x && (h = h * b + x[4], u = u * S + x[5]), _.filter = "", _.left = LM(h) + "px", _.top = LM(u) + "px";
                var P = this._imageEl,
                    L = this._cropEl;
                P || (P = kM.createElement("div"), this._imageEl = P);
                var O = P.style;
                if (v) {
                    if (e && n) O.width = LM(b * e * c / f) + "px", O.height = LM(S * n * d / p) + "px";
                    else {
                        var z = new Image,
                            E = this;
                        z.onload = function() {
                            z.onload = null, e = z.width, n = z.height, O.width = LM(b * e * c / f) + "px", O.height = LM(S * n * d / p) + "px", E._imageWidth = e, E._imageHeight = n, E._imageSrc = r
                        }, z.src = r
                    }
                    L || ((L = kM.createElement("div")).style.overflow = "hidden", this._cropEl = L);
                    var N = L.style;
                    N.width = LM((c + g * c / f) * b), N.height = LM((d + m * d / p) * S), N.filter = "progid:DXImageTransform.Microsoft.Matrix(Dx=" + -g * c / f * b + ",Dy=" + -m * d / p * S + ")", L.parentNode || y.appendChild(L), P.parentNode != L && L.appendChild(P)
                } else O.width = LM(b * c) + "px", O.height = LM(S * d) + "px", y.appendChild(P), L && L.parentNode && (y.removeChild(L), this._cropEl = null);
                var R = "",
                    B = i.opacity;
                B < 1 && (R += ".Alpha(opacity=" + LM(100 * B) + ") "), R += "progid:DXImageTransform.Microsoft.AlphaImageLoader(src=" + r + ", SizingMethod=scale)", O.filter = R, y.style.zIndex = UM(this.zlevel, this.z, this.z2), WM(t, y), null != i.text && this.drawRectText(t, this.getBoundingRect())
            }
        }, je.prototype.onRemove = function(t) {
            ZM(t, this._vmlEl), this._vmlEl = null, this._cropEl = null, this._imageEl = null, this.removeRectText(t)
        ...
        ! function(t, e) {
            ...
            var n = kM;
            eI || ((eI = n.createElement("div")).style.cssText = "position:absolute;top:-20000px;left:0;padding:0;margin:0;border:none;white-space:pre;", kM.body.appendChild(eI));
            try {
                eI.style.font = e
            } catch (t) {}
        ...
        for (var aI = new Xt, sI = [jg, Xe, je, xi, Av], lI = 0; lI < sI.length; lI++) {
            var hI = sI[lI].prototype;
            hI.drawRectText = function(t, e, n, i) {
                ...
                if (null != o && (o += ""), o) {
                    ...
                    if (v && !i && (aI.copy(e), aI.applyTransform(v), e = aI), i) c = e.x, d = e.y;
                    else {
                        var y = r.textPosition,
                            x = r.textDistance;
                        if (y instanceof Array) c = e.x + XM(y[0], e.width), d = e.y + XM(y[1], e.height), f = f || "left";
                        else {
                            var _ = me(y, e, x);
                    ...
                    var w, b, S, M = Vf,
                        I = this._textVmlEl;
                    I ? b = (w = (S = I.firstChild).nextSibling).nextSibling : (I = M("line"), w = M("path"), b = M("textpath"), S = M("skew"), b.style["v-text-align"] = "left", FM(I), w.textpathok = !0, b.on = !0, I.from = "0 0", I.to = "1000 0.05", WM(I, S), WM(I, w), WM(I, b), this._textVmlEl = I);
                    var C = [c, d],
                        T = I.style;
                    v && i ? ($(C, C, v), S.on = !0, S.matrix = v[0].toFixed(3) + "," + v[2].toFixed(3) + "," + v[1].toFixed(3) + "," + v[3].toFixed(3) + ",0,0", S.offset = (LM(C[0]) || 0) + "," + (LM(C[1]) || 0), S.origin = "0 0", T.left = "0px", T.top = "0px") : (S.on = !1, T.left = LM(c) + "px", T.top = LM(d) + "px"), b.string = HM(o);
                    try {
                        b.style.font = m
                    } catch (t) {}
                    KM(I, "fill", {
    ...
    Gf.prototype = {
        ...
        _getWidth: function() {
            var t = this.root,
                e = t.currentStyle;
            return (t.clientWidth || Hf(e.width)) - Hf(e.paddingLeft) - Hf(e.paddingRight) | 0
        },
        _getHeight: function() {
            var t = this.root,
                e = t.currentStyle;
            return (t.clientHeight || Hf(e.height)) - Hf(e.paddingTop) - Hf(e.paddingBottom) | 0
        }
    ...
    var uI = "http://www.w3.org/2000/svg",
        cI = ov.CMD,
        dI = Array.prototype.join,
        fI = "none",
        pI = Math.round,
        gI = Math.sin,
        mI = Math.cos,
    ...
    wI.brush = function(t) {
        var e = t.style,
            n = t.__svgEl;
        n || (n = Zf("path"), t.__svgEl = n), t.path || t.createPathProxy();
        var i = t.path;
        if (t.__dirtyPath) {
            i.beginPath(), t.buildPath(i, t.shape), t.__dirtyPath = !1;
            var r = Jf(i);
            r.indexOf("NaN") < 0 && $f(n, "d", r)
        }
        Qf(n, e), qf(n, t.transform), null != e.text && II(t, t.getBoundingRect())
    };
    var bI = {};
    bI.brush = function(t) {
        var e = t.style,
        ...
        if (n instanceof HTMLImageElement && (n = n.src), n) {
            var i = e.x || 0,
                ...
                a = e.height,
                s = t.__svgEl;
            s || (s = Zf("image"), t.__svgEl = s), n !== t.__imageSrc && (Kf(s, "href", n), t.__imageSrc = n), $f(s, "width", o), $f(s, "height", a), $f(s, "x", i), $f(s, "y", r), qf(s, t.transform), null != e.text && II(t, t.getBoundingRect())
        }
    };
    var SI = {},
        MI = new Xt,
        II = function(t, e, n) {
            ...
            if (null != r) {
                r += "";
                var o = t.__textSvgEl;
                o || (o = Zf("text"), t.__textSvgEl = o);
                var a, s, l = i.textPosition,
                    h = i.textDistance,
                    u = i.textAlign || "left";
                "number" == typeof i.fontSize && (i.fontSize += "px");
                var c = i.font || [i.fontStyle || "", i.fontWeight || "", i.fontSize || "", i.fontFamily || ""].join(" ") || Gg,
                    d = tp(i.textVerticalAlign),
                    f = (n = ce(r, c, u, d)).lineHeight;
                if (l instanceof Array) a = e.x + l[0], s = e.y + l[1];
                else {
                    var p = me(l, e, h);
                    a = p.x, s = p.y, d = tp(p.textVerticalAlign), u = p.textAlign
                }
                $f(o, "alignment-baseline", d), c && (o.style.font = c);
                var g = i.textPadding;
                if ($f(o, "x", a), $f(o, "y", s), Qf(o, i, !0), t instanceof Av || t.style.transformText) qf(o, t.transform);
                else {
                    if (t.transform) MI.copy(e), MI.applyTransform(t.transform), e = MI;
                    else {
                ...
                if ("baseline" === d ? (S = -n.height + f, g && (S -= g[2])) : "middle" === d ? (S = (-n.height + f) / 2, g && (s += (g[0] - g[2]) / 2)) : g && (S += g[0]), t.__text !== r || t.__textFont !== c) {
                    var M = t.__tspanList || [];
                    t.__tspanList = M;
                    for (C = 0; C < w; C++)(T = M[C]) ? T.innerHTML = "" : (T = M[C] = Zf("tspan"), o.appendChild(T), $f(T, "alignment-baseline", d), $f(T, "text-anchor", b)), $f(T, "x", a), $f(T, "y", s + C * f + S), T.appendChild(document.createTextNode(_[C]));
                ...
                var d = function() {
                    for (var n = -1 * a; n <= a; n += 2) {
                        ...
                        var d = h && h.newPos + 1 < r,
                            f = u && 0 <= c && c < o;
                        if (d || f) {
                            if (!d || f && h.newPos < u.newPos ? (s = ip(u), i.pushComponent(s.components, void 0, !0)) : ((s = h).newPos++, i.pushComponent(s.components, !0, void 0)), c = i.extractCommon(s, e, t, n), s.newPos + 1 >= r && c + 1 >= o) return np(0, s.components);
                            l[n] = s
                        } else l[n] = void 0
                    }
                    a++
    ...
    rp.prototype.createElement = Zf, rp.prototype.getDefs = function(t) {
        var e = this._svgRoot,
    ...
    }, rp.prototype.markAllUnused = function() {
        var t = this;
    ...
    }, rp.prototype.removeUnused = function() {
        var t = this.getDefs(!1);
        if (t) {
            var e = this;
    ...
    }, rp.prototype.getSvgProxy = function(t) {
        return t instanceof xi ? wI : t instanceof je ? bI : t instanceof Av ? SI : wI
    }, rp.prototype.getTextSvgElement = function(t) {
        return t.__textSvgEl
    }, rp.prototype.getSvgElement = function(t) {
        return t.__svgEl
    }, h(op, rp), op.prototype.addWithoutUpdate = function(t, e) {
        if (e && e.style) {
            var n = this;
        ...
        if (t.style) {
            var e = t.style.fill;
            e && e._dom && rp.prototype.markUsed.call(this, e._dom), (e = t.style.stroke) && e._dom && rp.prototype.markUsed.call(this, e._dom)
        }
    }, h(ap, rp), ap.prototype.update = function(t) {
    ...
    }, ap.prototype.updateDom = function(t, e, n) {
        if (e && e.length > 0) {
        ...
        t.__clipPaths && t.__clipPaths.length > 0 && d(t.__clipPaths, function(t) {
            t._dom && rp.prototype.markUsed.call(e, t._dom), t._textDom && rp.prototype.markUsed.call(e, t._textDom)
        })
    }, h(sp, rp), sp.prototype.addWithoutUpdate = function(t, e) {
        if (e && lp(e.style)) {
            var n, i = e.style;
    ...
    }, sp.prototype.update = function(t, e) {
        var n = e.style;
        if (lp(n)) {
            var i = this;
            rp.prototype.update.call(this, e, function(t) {
                i.updateDom(e, t._shadowDom)
            })
        } else this.remove(t, n)
    }, sp.prototype.remove = function(t, e) {
        ...
        var e = t.style;
        e && e._shadowDom && rp.prototype.markUsed.call(this, e._shadowDom)
    };
    var DI = function(t, e, n, i) {
        this.root = t, this.storage = e, this._opts = n = o({}, n || {});
        var r = Zf("svg");
        r.setAttribute("xmlns", "http://www.w3.org/2000/svg"), r.setAttribute("version", "1.1"), r.setAttribute("baseProfile", "full"), r.style.cssText = "user-select:none;position:absolute;left:0;top:0;", this.gradientManager = new op(i, r), this.clipPathManager = new ap(i, r), this.shadowManager = new sp(i, r);
    ...
    DI.prototype = {
        ...
        _paintList: function(t) {
            ...
            for (e = 0; e < h.length; e++) {
                ...
                if (c.added)
                    for (d = 0; d < c.count; d++) {
                        var s = mp(f = o[c.indices[d]]),
                            u = gp(f);
                        l ? dp(n, s, l) : fp(n, s), s ? dp(n, u, s) : l ? dp(n, u, l) : fp(n, u), dp(n, u, s), l = u || s || l, this.gradientManager.addWithoutUpdate(s, f), this.shadowManager.addWithoutUpdate(l, f), this.clipPathManager.markUsed(f)
                    } else if (!c.removed)
                        for (var d = 0; d < c.count; d++) {
                            var f = o[c.indices[d]];
                            l = s = gp(f) || mp(f) || l, this.gradientManager.markUsed(f), this.gradientManager.addWithoutUpdate(s, f), this.shadowManager.markUsed(f), this.shadowManager.addWithoutUpdate(s, f), this.clipPathManager.markUsed(f)
                        }
            }
        ...
        _getDefs: function(t) {
            var e = this._svgRoot,
                n = this._svgRoot.getElementsByTagName("defs");
            return 0 === n.length ? t ? ((n = e.insertBefore(Zf("defs"), e.firstChild)).contains || (n.contains = function(t) {
                var e = n.children;
                if (!e) return !1;
                for (var i = e.length - 1; i >= 0; --i)
                    if (e[i] === t) return !0;
        ...
        DI.prototype[t] = vp(t)
    }), vn("svg", DI), t.version = "4.1.0", t.dependencies = Hx, t.PRIORITY = Ux, t.init = function(t, e, n) {
        var i = $a(t);
        if (i) return i;
        var r = new Aa(t, e, n);
        return r.id = "ec_" + l_++, a_[r.id] = r, Pn(t, u_, r.id), Ya(r), r
    }, t.connect = function(t) {
        if (y(t)) {
            var e = t;
            t = null, Rx(e, function(e) {
                null != e.group && (t = e.group)
            }), t = t || "g_" + h_++, Rx(e, function(e) {
                e.group = t
            })
        }
        return s_[t] = !0, t
    }, t.disConnect = qa, t.disconnect = d_, t.dispose = function(t) {
        "string" == typeof t ? t = a_[t] : t instanceof Aa || (t = $a(t)), t instanceof Aa && !t.isDisposed() && t.dispose()
        ...
        e.geoJson && !e.features && (n = e.specialAreas, e = e.geoJson), "string" == typeof e && (e = "undefined" != typeof JSON && JSON.parse ? JSON.parse(e) : new Function("return (" + e + ");")()), c_[t] = {
            geoJson: e,
            specialAreas: n
        }
    }, t.getMap = function(t) {
        return c_[t]
    }, t.dataTool = f_, t.zrender = fm, t.graphic = Jv, t.number = hy, t.format = vy, t.throttle = ha, t.helper = ow, t.matrix = Yp, t.vector = Hp, t.color = cg, t.parseGeoJSON = sw, t.parseGeoJson = cw, t.util = dw, t.List = b_, t.Model = pr, t.Axis = uw, t.env = wp
});