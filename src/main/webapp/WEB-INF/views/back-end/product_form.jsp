					...
					<div class="row">
						<div class="col-12 col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<sf:form action="${base }/postproduct" method="post"
										modelAttribute="product" enctype="multipart/form-data">
										<sf:hidden path="id" />
										<div class="form-group">
											<label>Brand name</label>
											<sf:select path="brand.id" class="selectpicker"
												title="Choose one of the following...">
												<option disabled="disabled" selected="selected" hidden>Brand
													name</option>
										...
										<div class="form-group">
											...
											<sf:input path="productName" class="form-control" type="text"
										...
										<div class="form-group">
											...
											<sf:input path="salePrice" class="form-control" type="number"
												placeholder="Type sale price..." />
										</div>
										<div class="form-group">
											<label>Quantity</label>
											<sf:input path="orderQuantity" class="form-control"
												type="number" placeholder="Type quantity..." />
										</div>
										<div class="form-group">
											<label>Model</label>
											<sf:input path="model" class="form-control" type="type"
												placeholder="Type model..." />
										</div>
										<div class="form-group">
											<label>Description</label>
											<sf:textarea path="shortDescription" class="form-control"
												placeholder="Type description..." rows="4"></sf:textarea>
										</div>
										<div class="form-group">
											<label>Overview</label>
											<sf:textarea path="overview" class="form-control"
												placeholder="Type overview..." rows="4"></sf:textarea>
										</div>
										<div class="form-group">
											<label>Solution</label>
											<sf:textarea path="solution" class="form-control"
												placeholder="Type solution..." rows="4"></sf:textarea>
										</div>
										<div class="form-group">
											<label>Avatar 1</label>
											<input name="avatarProductFirst"
												class="form-control" type="file" />
										</div>
										<div class="form-group">
											<label>Avatar 2</label>
											<input name="avatarProductSecond"
												class="form-control" type="file" />
										</div>
										<div class="form-group">
											<label>Avatar cart</label>
											<input name="avatarProductCart"
												class="form-control" type="file" />
										</div>
										<div class="form-group">
											<label>Type name</label>
											<sf:select path="brand.classProduct.id" class="selectpicker"
												title="Choose one of the following...">
												<option disabled="disabled" selected="selected" hidden>Type
													name</option>
												<sf:options items="${classes }" itemValue="id"
													itemLabel="name" />
											</sf:select>
										</div>
										<div class="form-check mb-3">
											<sf:checkbox path="newProduct" class="form-check-input" value="1"
												id="defaultCheck2" checked="checked" /> <label
												class="form-check-label" for="defaultCheck2">New product</label>
										</div>
										<div class="form-check mb-3">
											<sf:checkbox path="highlight" class="form-check-input" value="1"
												id="defaultCheck1" /> <label class="form-check-label"
												for="defaultCheck1">Highlight product</label>
										</div>
