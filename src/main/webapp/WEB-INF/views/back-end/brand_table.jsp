				...
				<div class="content">
					<div class="card mb-0">
						...
						<div class="d-flex justify-content-end mt-3">
                            <a href="${base }/admin/add/brand" class="mr-4 btn btn-info btn-icon-animation">Add new <span class="btn-icon icofont-plus"></span></a>
                        </div> 
						<div class="card-body">
								...
								<table class="table data-table dataTable no-footer"
									...
									<c:forEach items="${brands }" var="brand">
										...
										<td class="sorting_1">${brand.id }</td>
											...
											<td><img src="${base }/upload${brand.logo }" class="img-thumbnail img-responsive" style="background: black;"></td>
											<td colspan="1">${brand.shotDescription }</td>
											<td><a href="${base }/admin/edit/brand/${brand.id }" class="btn btn-outline-success btn-square rounded-pill"><span class="btn-icon icofont-pencil-alt-1"></span></a>
                                                <a href="${base }/admin/delete/brand/${brand.id }" class="btn btn-error btn-square rounded-pill"><span class="btn-icon icofont-bin"></span></a></td>
										</tr>
									</c:forEach>
									</tbody>
								</table>
