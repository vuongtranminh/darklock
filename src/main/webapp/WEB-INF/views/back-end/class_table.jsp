				...
				<div class="content">
					<div class="card mb-0">
						...
						<div class="d-flex justify-content-end mt-3">
							<a href="${base }/admin/add/class" class="mr-4 btn btn-info btn-icon-animation">Add
								new <span class="btn-icon icofont-plus"></span>
							</a>
						</div>
						<div class="card-body">
								...
								<table class="table data-table dataTable no-footer"
									...
									<thead>
										<tr role="row">
											...
											<th class="sorting" tabindex="0"
												aria-controls="DataTables_Table_2" rowspan="1" colspan="1"
												aria-label="Office: activate to sort column ascending">Description</th>
											<th class="sorting" tabindex="0"
												aria-controls="DataTables_Table_2" rowspan="1" colspan="1"
												aria-label="Age: activate to sort column ascending">Manipulation</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${classes }" var="classproduct">
											<tr role="row" class="odd">
												<td class="sorting_1">${classproduct.id }</td>
												<td>${classproduct.name }</td>
												<td>${classproduct.shortDescription }</td>
												<td>
													<a href="${base }/admin/edit/class/${classproduct.id }" class="btn btn-outline-success btn-square rounded-pill">
														<span class="btn-icon icofont-pencil-alt-1"></span>
													</a>
													<a href="${base }/admin/delete/class/${classproduct.id }" class="btn btn-error btn-square rounded-pill">
