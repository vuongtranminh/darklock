				...
				<div class="content">
					<div class="card mb-0">
						...
						<div class="d-flex justify-content-end mt-3">
							<a href="${base }/admin/add/product" class="mr-4 btn btn-info btn-icon-animation">Add
									...
									<thead>
										<tr role="row">
											<th class="sorting_asc" tabindex="0"
												...
												aria-sort="ascending">Product Name</th>
											<th class="sorting" tabindex="0"
												aria-controls="DataTables_Table_2" rowspan="1" colspan="1"
												aria-label="Position: activate to sort column ascending">Image</th>
											<th class="sorting" tabindex="0"
												aria-controls="DataTables_Table_2" rowspan="1" colspan="1"
												aria-label="Office: activate to sort column ascending">Brand</th>
											<th class="sorting" tabindex="0"
												aria-controls="DataTables_Table_2" rowspan="1" colspan="1"
												aria-label="Age: activate to sort column ascending">Price</th>
											<th class="sorting" tabindex="0"
												aria-controls="DataTables_Table_2" rowspan="1" colspan="1"
												aria-label="Date: activate to sort column ascending">Sale Price</th>
											<th class="sorting" tabindex="0"
												aria-controls="DataTables_Table_2" rowspan="1" colspan="1"
									...
									<tbody>
										<c:forEach items="${listProduct }" var="product">
											<tr role="row" class="odd">
												...
												<td><img src="${base }/upload${product.avatarCart }"
													class="img-thumbnail img-responsive" alt=""></td>
												...
												<td><a
													...
													class="btn btn-outline-success btn-square rounded-pill">
														<span class="btn-icon icofont-pencil-alt-1"></span>
												</a> <a href="${base }/admin/delete/product/${product.id }"
													class="btn btn-error btn-square rounded-pill"> <span
														class="btn-icon icofont-bin"></span>
												</a></td>
											</tr>
										</c:forEach>
									</tbody>
