					...
					<div class="row">
						<div class="col-12 col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<sf:form action="${base }/postbrand" method="post"
										modelAttribute="brand" enctype="multipart/form-data">
										<sf:hidden path="id" />
										<div class="form-group">
											<label>Brand name</label> <sf:input path="name" class="form-control"
												type="text" placeholder="Type brand name..." />
										</div>
										<div class="form-group">
											<label>Logo</label> <input name="logoBrand" class="form-control"
												type="file" />
										</div>
										<div class="form-group">
											<label>Description</label> <sf:textarea path="shotDescription" class="form-control" placeholder="Type description..." rows="4"></sf:textarea>
										</div>
