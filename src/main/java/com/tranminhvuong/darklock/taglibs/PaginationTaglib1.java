...
@Getter
@Setter
public class PaginationTaglib1 extends SimpleTagSupport {
	...
	private String previous = "<i class=\"fa fa-angle-left\"></i>";
	private String next = "<i class=\"fa fa-angle-right\"></i>";
...
//			out.write("</nav>");
	...
	private String constructLink(int page, String text, String className, boolean disabled) {
		...
		if (disabled)
			...
			link.append(">")
					.append("<a href=\"" + uri + (uri.contains("?") ? "" : "?") + "offset=" + page + "\">" + text + "</a></li>");
